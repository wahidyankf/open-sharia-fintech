...
[01-checker-validation-steps.md](../../.claude/skills/swe-developing-applications-common/reference/checker-validation-steps.md)
...
[02a-checker-tdd-and-specs-completeness.md](../../.claude/skills/swe-developing-applications-common/reference/checker-tdd-and-specs-completeness.md)
covers TDD compliance and specs/Gherkin completeness for the direct-code path;
[02b-checker-regression-and-fixture-isolation.md](../../.claude/skills/swe-developing-applications-common/reference/checker-regression-and-fixture-isolation.md)
