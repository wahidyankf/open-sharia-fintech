...
1. **Start with an idea**: Capture the idea as a two-pager in `plans/ideas/<slug>.md` (see [Ideas Folder (Two-Pagers)](./03-ideas-folder-overview-rationale-and-file-layout.md#ideas-folder-two-pagers))
