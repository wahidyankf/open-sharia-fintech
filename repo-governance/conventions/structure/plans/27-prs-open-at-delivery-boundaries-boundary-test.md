...
Continues [PRs Open at Delivery Boundaries — Rules 5-7 and \*-to-pr Scope](./26-prs-open-at-delivery-boundaries-rules-continued.md).
...
The counterweight is rule 6 in [PRs Open at Delivery Boundaries — Rules 5-7](./26-prs-open-at-delivery-boundaries-rules-continued.md): the same instinct, over-applied, produces one end-of-plan mega-PR
...
See [Delivery Boundaries Declaration and Applicability](./28-delivery-boundaries-and-applicability.md) for the required declaration format and enforcement.
