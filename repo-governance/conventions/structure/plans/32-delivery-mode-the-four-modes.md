...
concern to [Worktree Specification](./29-worktree-specification.md#worktree-specification) above: a worktree is a **work
...
See [Delivery Mode — main-to-origin-main Content Restriction](./33-delivery-mode-content-restriction.md) for when direct-push modes are actually valid, and [Delivery Mode — Merge Authority and Resolution Precedence](./34-delivery-mode-merge-authority-and-precedence.md) for how the active mode is resolved.
