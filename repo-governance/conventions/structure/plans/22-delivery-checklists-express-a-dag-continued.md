...
Continues [Delivery Checklists Express a DAG (HARD RULE)](./21-delivery-checklists-express-a-dag.md).
...
[Worktree Cap](./31-worktree-cap.md#worktree-cap--one-worktree-per-repository-per-plan-hard-rule). Partial work
...
[PRs Open at Delivery Boundaries, Not Every Phase](./25-prs-open-at-delivery-boundaries-rules.md#prs-open-at-delivery-boundaries-not-every-phase-hard-rule).
