...
See [Delivery Checklists Express a DAG — Delivery Units and Planning Granularity](./22-delivery-checklists-express-a-dag-continued.md) for how DAG nodes map to delivery units, PRs, and the worktree cap.
