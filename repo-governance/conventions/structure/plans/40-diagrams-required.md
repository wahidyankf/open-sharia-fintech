...
- **ASCII Art**: Optional for general diagrams (simple directory trees or rare edge cases), but **Required** as the low-fidelity wireframe tier for **UI-bearing plans** — see [UI Mockups in Plan Docs](../../formatting/diagrams/42-ui-mockups-principles-and-scope.md#ui-mockups-in-plan-docs-principles-in-practice-and-scope) for the both-tiers rule, design funnel, and grounding rule
...
See [Diagrams in Plans — Skipping, Accessibility, and Example](./41-diagrams-skip-accessibility-and-example.md) for the escape hatch, the accessibility rules, and a worked example.
