...
Continues [PRs Open at Delivery Boundaries, Not Every Phase (HARD RULE)](./25-prs-open-at-delivery-boundaries-rules.md).
...
See [PRs Open at Delivery Boundaries — Boundary Test and Rationale](./27-prs-open-at-delivery-boundaries-boundary-test.md) for the four-part boundary test that determines whether a given phase is a delivery boundary.
