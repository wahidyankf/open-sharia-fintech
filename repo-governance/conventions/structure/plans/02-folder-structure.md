...
- The first lifecycle stage: ripe two-pagers are promoted to `backlog/` as full plans (see [Ideas Folder (Two-Pagers)](./03-ideas-folder-overview-rationale-and-file-layout.md#ideas-folder-two-pagers) below)
