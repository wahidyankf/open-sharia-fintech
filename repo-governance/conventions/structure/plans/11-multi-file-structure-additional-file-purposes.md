...
Continues the file-purpose list from [Multi-File Structure](./10-multi-file-structure-layout-and-core-files.md) for the remaining files in the five-document plan folder.
