...
6. **Worktree** — declared worktree path (`worktrees/<plan-identifier>/`) and provisioning command (see [Worktree Specification](./29-worktree-specification.md#worktree-specification))
