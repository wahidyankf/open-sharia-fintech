...
See [Executor Tagging — Git-Mechanical Steps](./18-executor-tagging-git-mechanical-steps.md) for the bias-to-[AI] rule and the three lifecycle steps most often mis-tagged, and [Executor Tagging — Placement, Legend, and Execution Semantics](./19-executor-tagging-placement-legend-and-execution-semantics.md) for how the tag is placed and enforced.
