...
- [Deterministic Validation: Allowlist, Code Lang, Multi-Perspective, Severity Audit](./specs-directory-structure/deterministic-validation-allowlist-code-lang-multi-perspective-severity.md) — The rhino-cli specs validation commands, the allowlist-driven default app selection, and the code_lang/gherkin/severity-downgrade fields DDD validators...
- [Deterministic Validation: Orphan Checks, Combined Scopes, Relationship Symmetry, Drift Detection](./specs-directory-structure/deterministic-validation-orphan-checks-combined-scopes-relationship-symmetry-drift.md) — The reverse-direction step orphan check, combined multi-perspective coverage runs, DDD relationship symmetry checks, and the current...
