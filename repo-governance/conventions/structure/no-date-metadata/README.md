...
- [No Manual Date Metadata: Tools and References](./tools-and-references.md) — The agents that enforce this convention, and links to the related conventions and development practices that cross-reference it. Read this when you need the enforcing agent names or the related-convention links for this rule.
