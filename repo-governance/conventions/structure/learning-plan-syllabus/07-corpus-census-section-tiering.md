...
from [Corpus Census: Corpus Shapes](./06-corpus-census-corpus-shapes.md). The
[Tiering Rule and Reproduction](./08-corpus-census-tiering-rule.md) child derives the tiers from this
table.
