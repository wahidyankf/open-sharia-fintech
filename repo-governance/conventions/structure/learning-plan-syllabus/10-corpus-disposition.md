...
[Custody Rule](./11-custody-rule.md)) declares, in its `tech-docs.md`, a `## Corpus Disposition`
...
right (see the [Learning-Bearing Trigger](./04-learning-bearing-trigger.md)'s negative example 2)
