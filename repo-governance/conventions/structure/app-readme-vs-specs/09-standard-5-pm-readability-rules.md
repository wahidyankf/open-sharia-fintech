...
The first occurrence of each niche project-specific term in a file carries a parenthetical gloss. Subsequent uses in the same file are gloss-free. Only the terms listed in the [glossary table](./08-standard-5-pm-readability-glossary.md) need glossing — anything not on that list is mainstream and must NOT be glossed.
