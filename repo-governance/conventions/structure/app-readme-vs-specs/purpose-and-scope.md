...
2. **Spec Tree Shape** — what the canonical logical owner corpus looks like and how it varies by surface profile.
...
- Migration path from five-folder spec trees to the logical owner corpus
