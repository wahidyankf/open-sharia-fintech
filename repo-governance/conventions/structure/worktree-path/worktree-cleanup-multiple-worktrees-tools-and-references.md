...
1. Resolve the exact path and branch from the plan's file-touch ledger. Continue only when it proves
   this plan created that worktree.
...
ledger-unknown, or another actor's worktree.
