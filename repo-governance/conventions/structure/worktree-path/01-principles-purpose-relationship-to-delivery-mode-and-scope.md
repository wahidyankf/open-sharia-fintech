...
the [Delivery Mode](../plans/32-delivery-mode-the-four-modes.md#delivery-mode) defined in the Plans Organization Convention. A
...
[Delivery Mode](../plans/32-delivery-mode-the-four-modes.md#delivery-mode) to resolve which mode a given plan uses before
