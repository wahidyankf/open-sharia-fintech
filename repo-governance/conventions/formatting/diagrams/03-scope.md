...
- **Vector graphics or images** - This convention is only for text-based diagrams (Mermaid and ASCII), **except** the high-fidelity `.excalidraw.png` plan mockups governed by the [UI Mockups in Plan Docs](./42-ui-mockups-principles-and-scope.md) section below
