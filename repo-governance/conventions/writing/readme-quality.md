...
- [1. Hook Readers Immediately](./readme-quality/hook-readers-immediately.md) — opening a motivation section with a problem-solution hook.
- [Guidelines: Scannability, Jargon, and Acronyms](./readme-quality/scannability-jargon-acronyms.md) — short paragraphs, plain language, and acronym context.
- [Guidelines: Benefits-Focused Language and Navigation Focus](./readme-quality/benefits-and-navigation.md) — framing features as benefits, and linking out instead of duplicating docs.
- [7. Conversational Tone and Quality Checklist](./readme-quality/conversational-tone-and-checklist.md) — friendly tone plus the full pre-commit quality checklist.
