...
This page continues [Required Sections](./02-document-structure-required-sections.md) with the sections that are recommended, then optional, for a convention document.
