...
See also [Code Examples, External References, and Mathematical Notation](./04-core-methodology-code-references-math.md) and [Diagrams, Structure, and Indentation Validation](./05-core-methodology-diagrams-structure-indentation.md) for the remaining checks in this methodology.
