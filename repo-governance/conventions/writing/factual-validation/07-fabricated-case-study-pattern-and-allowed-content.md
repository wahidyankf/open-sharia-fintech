...
See [Detection and Remediation](./08-fabricated-case-study-detection-and-remediation.md) for the suspension test, checker detection pattern, and how to fix a fabricated claim.
