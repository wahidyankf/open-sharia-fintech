...
- [Path Verification Checklist](./path-verification-checklist.md) — A pre-commit checklist for verifying AyoKoding relative-path links before committing documentation. Use right before committing documentation that adds or edits an AyoKoding reference link.
...
- [Real-World Context](./real-world-context.md) — The historical incident that prompted this convention — 50+ instances of public ayokoding.com URLs found in docs/explanation/. Use when you need the origin story or impact rationale behind this convention, e.g. in a proposal to extend or relax it.
- [References](./references.md) — Related conventions, principles, and the docs-checker/docs-fixer agents that enforce AyoKoding relative-path linking. Use when you need to jump from this convention to the broader linking convention, the principles it implements, or the agents that validate it.
