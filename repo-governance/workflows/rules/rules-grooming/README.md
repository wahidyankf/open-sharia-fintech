...
- [Grooming Log](./grooming-log.md) — One terse entry per run with its census delta, and the last-groomed date Step 1's recurrence trigger reads. Use when checking whether a sweep is due, or recording a completed one.
