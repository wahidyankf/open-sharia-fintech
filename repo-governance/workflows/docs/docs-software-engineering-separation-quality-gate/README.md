...
- [Notes](./notes.md) — Summary notes: fully automated, idempotent, conservative fixer behavior, observable, bounded, scope-aware, and incremental migration support. Use for a quick-reference summary of the workflow's key operating characteristics.
