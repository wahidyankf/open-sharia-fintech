---
description: "Lists the governance principles this workflow implements (explicit over implicit, automation, simplicity, accessibility, progressive disclosure, no time estimates)."
