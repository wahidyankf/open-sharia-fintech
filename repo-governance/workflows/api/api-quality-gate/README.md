...
- [Step 4: Verification](./step-4-verification.md) — How one rebuild/redeployment precedes verification of original findings and a smoke test of affected API behavior. Use after Step 3.
...
- [Success Criteria](./success-criteria.md) — Clean-discovery, verified-fix, partial, and lifecycle
  scenarios. Use when validating the bounded API quality gate's observable behavior.
