...
- [Phase 3: Clearance Table & Decisions](./phase-3-clearance-table-and-decisions.md) — Assembles the Security & Functional Clearance Status table and writes the clearance report progressively to generated-reports/. Use when turning per-package classifications into the final clearance table and report.
...
- [Gherkin Success Criteria](./gherkin-success-criteria.md) — Three Gherkin scenarios covering the no-manifest-touch guarantee, functional-hold surfacing, and checkpoint decline. Use when verifying or testing this workflow's observable behavior against its acceptance criteria.
