...
- [Steps 3-5 — Fixer, CI Gate, Done-Check](./pr-review-quality-gate/steps-3-5-fixer-ci-gate-done-check.md) — triage, gate, final status.

### API Mechanics and Done-Definition

- [GitHub Reviews API Mechanics — Part 1](./pr-review-quality-gate/github-reviews-api-mechanics-part-1.md) — the pinned SHA and anchors.
...
- [Route-Specific Done-Definition](./pr-review-quality-gate/route-specific-done-definition.md) — the five done items.
...
- [Notes](./pr-review-quality-gate/notes.md) — operating notes, staleness.
