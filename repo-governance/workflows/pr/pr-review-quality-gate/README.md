...
- [PR-Review Quality Gate — Cycle Record Authentication](./cycle-record-authentication.md) — Authenticates every API record before it contributes durable review state.
