...
See [Hardened Merge Preconditions — Notes and Merge Mechanics](./12-hardened-merge-preconditions-notes.md) for the normative-lettering note, the merge-command mechanics, and the done-boundary diagram.
