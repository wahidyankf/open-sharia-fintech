...
description: Documents the apps-ayokoding-www-primer-fixer agent invocation, its mode-scoped fix strategy, and which fixes are HIGH/MEDIUM confidence versus false-positive risks.
when_to_use: Use when running or interpreting the fixer step of the Primer quality gate.
---
