...
[Inputs Reference — Part 2](./15-inputs-reference-part-2-and-outputs.md)). See
[Inputs at a Glance and Grilling](./02-inputs-at-a-glance-and-grilling.md) for the readable
