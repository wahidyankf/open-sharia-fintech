...
- **Task list expansion**: append the repo's delivery checklist to the live Task list as
  flattened tasks per the [Granular Task List Contract](./02-execution-mode-and-task-list-contract.md#granular-task-list-contract-composite-wide-non-negotiable)
...
**Continues in** [Step 4 — Execution Phase (Continued)](./06-step-4-execution-phase-continued.md).
