...
- [Purpose, Scope, and Relationship to plan-takeover-execution.md](./purpose-scope-and-relationship.md) — What a handover captures, when (not) to write one, and how this write-side workflow relates to plan-takeover-execution.md's read side. Use when deciding whether a handover is warranted, or clarifying how this workflow's output feeds the takeover workflow.
- [Why This Exists](./why-this-exists.md) — Explains the two kinds of knowledge delivery.md alone can't capture — non-checkbox state and paid-for gotchas — and the three outcomes skipping a handover risks. Use when justifying why a handover is worth writing instead of relying on delivery.md alone.
