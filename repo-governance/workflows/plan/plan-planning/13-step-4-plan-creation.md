...
Invoke `plan-maker` to write the plan in the resolved `<plan-dir>` (see [Stage Resolution](./01-stage-resolution.md#stage-resolution)).
...
[canonical envelope schema](../../../development/workflow/grilling-with-options/06-user-decisions-required-envelope.md#user-decisions-required-envelope),
...
[Resolved User Decisions Envelope](../../../development/workflow/grilling-with-options/07-resolved-user-decisions-envelope.md#resolved-user-decisions-envelope)
