...
8. **PR vs. direct push — Delivery Mode**: Confirm which of the four
   ...
   later by [plan-execution.md Step 0](../plan-execution/14-enter-worktree-preconditions-and-work-branch.md#0-enter-the-designated-worktree-sequential-hard-gate).
