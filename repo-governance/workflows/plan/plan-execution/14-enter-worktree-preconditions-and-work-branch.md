...
[How to Execute](./01-execution-mode.md) list above — `git mv` to `plans/in-progress/`, committed and
...
[Execute Plan from Backlog](./44-example-usage-and-iteration-example.md#execute-plan-from-backlog) for the full worked example.
