...
[plan-planning §Vercel MCP Availability](../plan-planning/06-vercel-mcp-availability.md#vercel-mcp-availability-surface-conditional)).
...
- **Touches one, and the probe disagrees** → do **not** proceed as written. Downgrade every affected
  `[AI]` step per [§Degraded Mode](../../../development/infra/vercel-mcp/04-identifier-hygiene-degraded-mode-and-when-to-check.md#degraded-mode), record the
