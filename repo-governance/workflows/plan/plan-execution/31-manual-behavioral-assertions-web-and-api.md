---
title: "Manual Behavioral Assertions — Web UI and API Verification"
...
when_to_use: Use when a phase touches web UI or API code and its behavior must be manually verified before proceeding.
---

# Manual Behavioral Assertions — Web UI and API Verification
