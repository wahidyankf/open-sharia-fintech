...
construct the canonical [Resolved User Decisions Envelope](../../../development/workflow/grilling-with-options/07-resolved-user-decisions-envelope.md#resolved-user-decisions-envelope)
