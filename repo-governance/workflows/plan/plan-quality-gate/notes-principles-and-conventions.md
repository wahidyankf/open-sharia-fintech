...
- **[Plans Organization Convention](../../../conventions/structure/plans.md)**: Workflow validates
  the prospective fixed core, reader-led technical shape, comprehensive semantics, granular outcome-section checklists,
  and worktree section per the convention
...
- **[Plans Organization Convention §Delivery Mode](../../../conventions/structure/plans/delivery-mode-the-four-modes.md#delivery-mode)**: for `*-to-pr`, this workflow's `pass` is pre-execution evidence, not a substitute for exact-head/base PR CI, current-head leak review, applicable surface gates, or merge preconditions
