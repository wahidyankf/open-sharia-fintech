...
Continued in
[Phase A — Edges, Report, and Diagram](./04-phase-a-edges-report-and-diagram.md).
...
- **Promote every resolved `plans/backlog/` entry before scheduling.** For each plan in the frozen
  ...
  [`plan-execution.md` Step 0](../plan-execution/14-enter-worktree-preconditions-and-work-branch.md) —
