...
Step 0](../plan-execution/14-enter-worktree-preconditions-and-work-branch.md) (including
...
run that plan's [per-phase quality gate](../plan-execution/24-per-phase-quality-gate-gates.md),
[post-push CI verification](../plan-execution/28-post-push-ci-verification-overview.md),
and [manual behavioral assertions](../plan-execution/31-manual-behavioral-assertions-web-and-api.md)
