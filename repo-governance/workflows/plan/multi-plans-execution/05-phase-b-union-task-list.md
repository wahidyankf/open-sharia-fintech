...
Surface](../plan-execution/09-harness-task-list-primary-observability-surface.md) rules. Coarse tasks,
...
Ritual](../plan-execution/10-atomic-sync-ritual.md) applies **per plan against that plan's own
...
rule 6](../plan-execution/11-resume-reconciliation.md)).
