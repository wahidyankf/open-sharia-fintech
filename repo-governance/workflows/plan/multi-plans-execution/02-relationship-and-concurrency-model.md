...
model](../plan-execution/08-task-checklist-synchronization.md), the [Atomic Sync
Ritual](../plan-execution/10-atomic-sync-ritual.md), [Resume Reconciliation (disk is
truth)](../plan-execution/11-resume-reconciliation.md), the [Iron
Rules](../plan-execution/12-iron-rules-1-5.md), Steps 0–8, per-phase quality gates,
