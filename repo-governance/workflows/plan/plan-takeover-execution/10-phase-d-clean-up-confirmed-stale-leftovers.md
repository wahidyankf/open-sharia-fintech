...
1. Run the full [Worktree and Artifact Cleanup Convention](../../../development/workflow/worktree-and-artifact-cleanup/05-mandatory-pre-removal-checks.md#mandatory-pre-removal-checks)
...
3. Build-artifact cleanup is scoped to output produced **inside the removed worktree only**
   ...
   [Build-Artifact Cleanup](../../../development/workflow/worktree-and-artifact-cleanup/07-build-artifact-cleanup.md#build-artifact-cleanup)
