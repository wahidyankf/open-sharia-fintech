...
**Continued in** [Phase A — Per-Repo Probes and Persistence](./06-phase-a-discovery-per-repo-probes-and-persistence.md) for the ordered per-repo probe list (A2) and the persist-as-you-go rule (A3).
