...
description: Cross-references from the UI quality gate to its checker, fixer, and maker agents, and to frontend conventions.
when_to_use: Use when looking for documentation related to the UI quality gate.
---
