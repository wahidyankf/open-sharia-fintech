...
| Generated binding mirrors                        | Derived rules — in scope to read, never to hand-edit, except the `class: vendored` carve-out (see [Governance Surfaces § the two subclasses](./vendored-exception-subclasses.md)) |
