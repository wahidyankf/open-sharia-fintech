...
| **Wholly external**  | `reason:` states there is no in-repo source (e.g. `.agents/skills/cavecrew`, `.agents/skills/caveman*`, `.opencode/opencode.json`) | **Fully hand-maintained.** There is no delimited region and nothing to regenerate; the whole path is authored by hand.                                                                                                                |
