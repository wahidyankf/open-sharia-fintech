...
3. **Security**: No accidental permissions or unexpected behaviour
...
1. **Hidden Behaviour**: "Magic" that works until it doesn't
2. **Insider Knowledge**: Requires tribal knowledge to understand
3. **Debugging Nightmares**: Hard to trace where behaviour comes from
