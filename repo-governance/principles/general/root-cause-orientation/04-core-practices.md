...
See [Implementation Workflow - Surgical Changes](../../../development/workflow/implementation/05-surgical-changes-principle.md) for detailed guidance on applying minimal impact in practice.
