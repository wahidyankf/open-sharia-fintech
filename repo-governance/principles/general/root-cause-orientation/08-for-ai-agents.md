...
See [Implementation Workflow - Surgical Changes](../../../development/workflow/implementation/05-surgical-changes-principle.md) for the detailed surgical changes practice that implements minimal impact for software changes.
