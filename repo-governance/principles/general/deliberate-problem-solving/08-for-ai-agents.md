...
See [Information Accuracy and Verification section in AI Agents Convention](../../../development/agents/ai-agents/39-information-accuracy-verification-principles.md) for agent-specific verification requirements.
