...
| **Checker**       | Read, Glob, Grep, Write, Bash       | Validation with audit report generation       | repo-rules-checker | Needs Write for reports in `local-tmp/<agent-family>/`, Bash for timestamps |
