...
**Every agent MUST include a "Reference Documentation" section** at the end. See the [Document Structure](./09-agent-file-structure-document-structure.md) section below for the complete format.
