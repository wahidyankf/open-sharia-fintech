...
This repository maintains **multi-harness compatibility** across multiple AI coding agent platforms. The primary platform binding directory (`.claude/`) is the source of truth; secondary directories (`.opencode/`, `.codex/`, `.agents/`) are auto-generated by the sync script.
...
├── .codex/                 # Codex CLI configuration (SECONDARY - Auto-generated)
│   ├── agents/             # agents in Codex format (generated from .claude/)
│   └── config.toml         # Codex configuration
└── .agents/                # Cross-harness skills surface (SECONDARY - Auto-generated)
    └── skills/             # skills mirrored from .claude/skills/
```
...
4. Changes automatically regenerate `.opencode/`, `.codex/` and `.agents/` (SECONDARY)
