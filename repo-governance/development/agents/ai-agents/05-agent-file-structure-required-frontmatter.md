...
**Format Note**: This example shows the **primary platform binding format** (`.claude/agents/`). Secondary platform directories use different representations for tools and model references — see the [Platform Binding Examples](./18-platform-binding-examples-color-translation-table.md) section above for specifics.
