...
- [Platform Binding Examples](./13-platform-binding-examples.md) — Covers the Claude Code and Cursor model-ID mapping tables, tier collapse, and why glm-5.2 is the OpenCode default. Use when translating a model tier to a concrete model ID for a specific harness.
