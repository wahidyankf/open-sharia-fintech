...
**Priority-Based Execution** (see [Fixer Confidence Levels Convention - Integration](../../quality/fixer-confidence-levels/13-integration-with-criticality-levels-orthogonal-dimensions-and-decision-matrix.md)):
