...
**Color**: 🟦 Blue (Writer agents) or 🟨 Yellow (rules-maker uses bash)

**Examples**:

| Agent                               | Creates/Updates                                    | Also Manages                                      | Tools Used            |
| ----------------------------------- | -------------------------------------------------- | ------------------------------------------------- | --------------------- |
| rules-maker                         | Convention docs, AGENTS.md sections, agent prompts | Cross-references, indices, related documentation  | Bash (not Edit/Write) |
...
**Note**: `rules-maker` is a special case that uses bash commands (cat, sed, awk) instead of Edit/Write tools for file operations.
