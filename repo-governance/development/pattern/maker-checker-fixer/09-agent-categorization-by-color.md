...
See [AI Agents Convention - Agent Color Categorization](../../agents/ai-agents/17-agent-color-categorization.md#agent-color-categorization) for complete details, including the [Platform Binding Color Translation](../../agents/ai-agents/17-agent-color-categorization.md#platform-binding-color-translation) subsection that documents how named colors map to platform binding color tokens via `rhino-cli harness bindings generate`.
