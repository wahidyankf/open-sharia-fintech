...
- [Function Composition](./functional-programming/function-composition.md) — The pipe pattern, compose pattern, and higher-order functions for building complex behavior from simple functions. Use when you need to combine several small functions into a single pipeline or transformation.
