...
- [Principles and Conventions](./principles-and-conventions.md) — The core principles and conventions this pattern implements - explicitness, pure functions, simplicity, and functional programming. Use when you need to trace a CLI hexagonal-architecture rule back to the principle or convention it implements.
...
- [Layer Responsibilities](./layer-responsibilities.md) — What each CLI layer is responsible for - commands/ as inbound adapter, domain/, application/, and infrastructure/. Use when deciding which CLI layer a piece of code belongs in.
