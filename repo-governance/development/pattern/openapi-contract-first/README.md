...
- [Overview and Spec Location](./overview-and-spec-location.md) — How contract-first codegen works end to end, and where each backend app's OpenAPI spec file lives. Use when locating the OpenAPI spec file for a given backend app, or explaining the contract-first workflow.
