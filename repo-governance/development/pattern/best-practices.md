...
- [Practice 7: Compose Small Functions](./best-practices/compose-small-functions.md) — Build complex behaviour from small, composable, reusable functions rather than one large function. Use when a function is growing large and could be decomposed into smaller composable functions.
