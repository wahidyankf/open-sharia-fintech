...
- [Development Practices](./practice/README.md) — Day-to-day practices for solving repository work carefully and collaboratively. Use when the work is ambiguous, shared, or already in motion, and you need a behavioral practice rather than a code pattern or tool configuration.
