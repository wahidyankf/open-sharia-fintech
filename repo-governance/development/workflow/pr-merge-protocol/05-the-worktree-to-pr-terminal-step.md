...
the [Trunk Based Development Convention](../trunk-based-development/09-default-delivery-mode-worktree-to-pr.md#default-delivery-mode-worktree-to-pr)),
...
action gated on the five preconditions in [The Rule](./02-the-rule.md#the-rule) above and performed by `[AI]`.
