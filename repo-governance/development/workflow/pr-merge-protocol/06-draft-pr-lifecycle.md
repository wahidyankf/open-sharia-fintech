...
Per the [Trunk Based Development Convention](../trunk-based-development/10-why-draft-and-direct-push-modes.md#why-draft-not-ready-for-review-on-open),
...
3. **`[AI]` flips to ready** -- once the done-definition is met, `[AI]` runs `gh pr ready` (or marks it ready in the GitHub UI). **This is where the PR Merge Protocol precondition gate fires.** The agent must:
   ...
   - Verify all five preconditions in [The Rule](./02-the-rule.md#the-rule) hold.
