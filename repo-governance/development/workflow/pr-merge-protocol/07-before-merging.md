...
[The Rule](./02-the-rule.md#the-rule) above and defined normatively in
[the PR Review Quality Gate](../../../workflows/pr/pr-review-quality-gate/11-hardened-merge-preconditions-a-e.md).
