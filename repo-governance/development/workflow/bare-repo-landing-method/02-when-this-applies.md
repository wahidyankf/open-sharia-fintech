...
Reconcile](./05-terminal-reconcile.md#terminal-reconcile) table's second row — `git fetch` then `git merge --ff-only
...
[Terminal Reconcile](./05-terminal-reconcile.md#terminal-reconcile) table's "Why this form" column and
