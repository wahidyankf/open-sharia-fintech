...
| `chore`    | Dependency updates and repository housekeeping | `chore(deps): resync package-lock.json`                |
...
- Build tool configuration, such as Nx cache inputs
- Compiler and analyzer settings
- Container image and packaging setup

**`chore`** - Maintenance tasks

- Dependency and lockfile updates, conventionally scoped `chore(deps)`
- Release preparation
- Repository housekeeping that touches neither source nor tests
