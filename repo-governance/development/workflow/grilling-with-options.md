...
- [Principles and Conventions Implemented](./grilling-with-options/01-principles-and-conventions-implemented.md) — Why this convention exists.
- [Purpose and Scope](./grilling-with-options/02-purpose-and-scope.md) — Why grilling replaces prose questions; what is covered.
- [Rule 1 and Rule 2](./grilling-with-options/03-rule-1-and-rule-2.md) — Explore before asking; 2-4 structured options.
- [Rule 3 and Rule 4](./grilling-with-options/04-rule-3-and-rule-4.md) — Trade-off per option; exactly one Recommended.
- [Rule 5 and Rule 6](./grilling-with-options/05-rule-5-and-rule-6.md) — One decision per question; the native-tool mechanism.
- [User Decisions Required Envelope](./grilling-with-options/06-user-decisions-required-envelope.md) — The outbound subagent-to-root envelope.
- [Resolved User Decisions Envelope](./grilling-with-options/07-resolved-user-decisions-envelope.md) — The inbound root-to-subagent payload.
- [Staged Native Rendering](./grilling-with-options/08-staged-native-rendering.md) — Rendering 3-4 leaves through a 2-3-option native tool.
- [Markdown Fallback Format](./grilling-with-options/09-markdown-fallback-format.md) — The inline format for non-interactive roots.
- [Rule 7 and Rule 8](./grilling-with-options/10-rule-7-and-rule-8.md) — Unlisted answers; the two standing options.
- [When This Convention Applies](./grilling-with-options/11-when-this-convention-applies.md) — The six triggering contexts.
