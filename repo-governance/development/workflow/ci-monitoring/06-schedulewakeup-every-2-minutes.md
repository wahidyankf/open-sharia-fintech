...
Use the first approach that fits the situation. Only fall back to lower-priority approaches when the higher-priority one is not applicable — see [Manual Poll Loop With 2-Minute Sleep](./07-manual-poll-loop-with-2-minute-sleep.md) for the fallback.
