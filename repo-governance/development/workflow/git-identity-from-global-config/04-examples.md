...
[Reproducible Environments Convention §Git Identity Guardrail](../reproducible-environments/12-git-identity-guardrail.md#git-identity-guardrail)
— removal is a human-only fix, applied via the commands in
[Remediation](./05-remediation-and-sibling-repos.md#remediation).
