...
**Principle**: Integrate incomplete behaviour only as an internally complete-and-inert increment
...
- Gradual rollouts
- Enabled and disabled behaviour stays tested, with an explicit rollback and flag-removal path
