...
3. Record a written reason in the plan (or the session, if no plan exists) for why the underlying
   ...
   Operations](../no-destructive-git-operations/05-no-corner-cutting-and-preferring-additive-operations.md#no-corner-cutting--root-cause-orientation-is-binding)
