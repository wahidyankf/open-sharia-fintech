...
plan checking, plan fixing, and plan execution. The canonical four-mode vocabulary and the three-tier
precedence that resolves which mode is active live in the
