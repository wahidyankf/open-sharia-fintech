...
- [Examples](./examples.md) — Worked pass/fail examples of CI post-push verification, including how to fix a failure found during verification. Use when you need a concrete example of correct or incorrect CI post-push verification behaviour.
