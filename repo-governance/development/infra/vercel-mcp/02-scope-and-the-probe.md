...
| **Absent**                      | Degraded mode (see [Degraded Mode](./04-identifier-hygiene-degraded-mode-and-when-to-check.md#degraded-mode)). The plan still ships; its verification steps change shape. |
