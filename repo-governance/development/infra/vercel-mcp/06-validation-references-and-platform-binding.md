...
description: The agents that validate this convention, related standards and workflows, and the Claude Code platform-binding details for listing MCP servers.
...
tags:
  ...
  - verification
created: 2026-08-01
when_to_use: Use when looking up which agent validates this convention, finding related documentation, or checking the Claude Code MCP-listing binding.
---
