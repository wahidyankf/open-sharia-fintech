...
- [Mandatory Targets — Summary Matrix](./nx-targets/mandatory-targets-summary-matrix.md) — Real vs. echo targets, by type. Use for a quick per-type check.
- [Mandatory Targets — Mandatory-Six and Required-Where-Applicable Targets](./nx-targets/mandatory-targets-all-projects-six-and-required.md) — Always-required and conditional targets. Use when scaffolding project.json.
- [Mandatory Targets — test:quick Composition and Gate-Surface Rule](./nx-targets/mandatory-targets-all-projects-quick-and-gate.md) — The 5-step test:quick chain. Use when wiring test:quick.
...
- [Projects with Integration Tests](./nx-targets/mandatory-targets-integration-tests.md) — Docker+PostgreSQL vs. mocking patterns. Use when writing test:integration.
...
- [Specs:Behavior:Coverage Projects](./nx-targets/mandatory-targets-specs-behavior-coverage.md) — Command flags, per-project status. Use when debugging this target.
...
- [Anti-Patterns — Echo Placeholders](./nx-targets/anti-patterns-echo-placeholders.md) — Echo placeholders are required, not anti-patterns. Use when a project lacks real integration/E2E tests.
