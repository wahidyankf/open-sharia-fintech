...
Continues [UUID Chain Generation](./03-uuid-chain-generation.md).
...
Continued in [UUID Chain Generation — Limitations, Compatibility, and Rationale](./05-uuid-chain-limitations-and-rationale.md).
