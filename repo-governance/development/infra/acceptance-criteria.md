...
- [Integration with Test Automation](./acceptance-criteria/06-integration-with-test-automation.md) — Mapping Gherkin scenarios to step definitions in Cucumber.js, Jest-Cucumber, Behave, and Godog. Use when wiring a Gherkin scenario to a BDD test framework in JavaScript/TypeScript, Python, or Go.
