...
- [Integration with Test Automation](./acceptance-criteria/integration-with-test-automation.md) — Mapping Gherkin scenarios to step definitions in Cucumber.js, Jest-Cucumber, and cucumber-rs. Use when wiring a Gherkin scenario to a BDD test framework in TypeScript, Rust, or F#.
