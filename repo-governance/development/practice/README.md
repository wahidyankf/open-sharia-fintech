...
- [Parallel-by-Default Practice](./parallel-by-default.md) — Run independent work in parallel within the declared cap, while serializing cross-repository worktree setup, toolchain setup, builds, and validation by default on the shared machine. Use when scheduling independent work or a multi-repository plan.
