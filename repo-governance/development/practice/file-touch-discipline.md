...
- **Every session, in every OSE repository** — `ose-public`, `ose-primer`, `ose-private` — and in
...
(see [Bare-Repo Landing Method](../workflow/bare-repo-landing-method.md#terminal-reconcile)),
