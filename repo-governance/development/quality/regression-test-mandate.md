...
- [Test Form by Defect Type](./regression-test-mandate/test-form-by-defect-type.md) — Required test form per defect type: behavioral, visual, content, integration. Use when deciding what kind of test a defect type requires.
