...
[Absence and Completeness Claims](./06-absence-and-completeness-claims-zero-result-search-evidence-part-1.md).
...
[A concept sweep validated by its own regex](./09-absence-and-completeness-claims-concept-sweep-part-1.md).
