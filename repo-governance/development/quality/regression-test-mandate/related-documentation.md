...
- [Feature Change Completeness Convention](.././feature-change-completeness.md) -- The feature-change
  dual of this mandate; together they cover all behaviour-altering work
- [Behaviour-Driven Development](../../behaviour-driven-development.md) -- Which test level applies
...
- [Specs-Application Sync Convention](.././specs-application-sync.md) -- Bidirectional sync between
  specs/ and application code; behavioural regression tests belong in specs/
