...
Every test or fixture in scope (see [Scope](./04-scope.md) above) MUST implement **all six** of the
following layers. None of the six is optional, and none substitutes for another -- each closes a
distinct escape mechanism (see [Why Defense-in-Depth](./12-why-defense-in-depth-not-a-single-assertion.md)
