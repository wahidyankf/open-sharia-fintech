...
2. **Interactions work**: Click buttons, fill forms, and navigate between pages. Confirm the expected behaviour occurs.
...
7. **All breakpoints verified**: Repeat at mobile (375 px), tablet (768 px), and desktop (1280 px). Responsive behaviour at one viewport does not imply correct behaviour at others.
