...
- [The Rule](./the-rule.md) — The manual-verification rule for UI/API changes. Use for the exact wording of the rule.
- [UI Verification](./ui-verification.md) — Required tools for manual UI verification. Use when preparing to manually verify a UI change.
- [UI Verification Checklist](./ui-verification-checklist.md) — The checklist to run through when verifying a UI change. Use when manually verifying a UI change.
- [Example: UI Feature Verification (multi-locale app)](./example-ui-feature-verification-multi-locale-app.md) — A worked example of manually verifying a UI feature across locales. Use for a concrete example of multi-locale UI verification.
- [API Verification](./api-verification.md) — How to manually verify an API endpoint with curl. Use when preparing to manually verify an API change.
...
- [Tools and Automation](./tools-and-automation.md) — Tools used for manual behavioural verification. Use when locating a manual-verification tool.
