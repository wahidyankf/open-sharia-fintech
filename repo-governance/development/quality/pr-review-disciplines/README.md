...
- [Cost/Noise Control: Plans-Only Review Route](./cost-control-noise-control-mechanics-plans-only-route.md) — The fresh-per-cycle five-specialist route, primary secrets probe, and implementation suppression. Use when a PR contains only plan documents and required indexes.
