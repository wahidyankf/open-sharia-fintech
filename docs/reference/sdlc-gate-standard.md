...
| Repo-wide cross-file pre-push gates (md-links, readme-index, harness-duplication, convention-license) | ✅     | All 4 present as direct `rhino-bin.sh` calls in all 3 repos' `.husky/pre-push` + both CI gates.                                                                                                                                                                                                                                                                                                                                                                           |
