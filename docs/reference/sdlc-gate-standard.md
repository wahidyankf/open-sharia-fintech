...
| `repo-config.yml` section schema                                                                      | ✅     | 6 identical top-level sections (`harness`, `coverage`, `specs`, `governance-word-budget`, `env-contract`, `env-injection`) in all 3.                                                                                                                                                                                                                                                                                                                                      |
