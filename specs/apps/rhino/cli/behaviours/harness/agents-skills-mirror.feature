...
Feature: .agents/skills/ is a generated real-file mirror
  ...
  # Exemption(e2e): this scenario owns repository-local npm script delegation rather than the published Rhino CLI boundary; alternative-proof: rhino-cli:test:integration / The npm entry points cover the new mirror
  @e2e-exempt
  ...
  # Exemption(e2e): formatter interoperability crosses the repository's private npm/prettier toolchain rather than Rhino's public process route; alternative-proof: rhino-cli:test:integration / The emitted mirror survives the formatter
  @e2e-exempt
