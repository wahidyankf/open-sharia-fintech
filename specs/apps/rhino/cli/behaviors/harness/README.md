...
> Threshold behavior now lives in `gherkin/governance/governance-word-budget.feature`; this
> directory retains only harness-specific governance and pre-push behavior.
