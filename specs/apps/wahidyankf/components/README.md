# wahidyankf-www — Components (C4 L3)

Audience: Engineers, Technical Product/Project Managers

Component-level specifications for wahidyankf-www — what lives inside the `web` container,
...
- [wahidyankf-www — Web Components (C4 L3)](./web/README.md)
