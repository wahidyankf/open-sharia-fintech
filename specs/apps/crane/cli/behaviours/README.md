...
Behavioural specifications for all crane-cli commands. Each feature file maps to one command
...
- [crane — cli/behaviours/content](./content/README.md) — Gherkin scenarios for crane-cli text content validation checks
- [crane — cli/behaviours/media](./media/README.md) — Gherkin scenarios for crane-cli media and visual element checks
- [crane — cli/behaviours/pdf](./pdf/README.md) — Gherkin scenarios for crane-cli PDF extraction commands
- [crane — cli/behaviours/reporting](./reporting/README.md) — Gherkin scenarios for crane-cli report and skiplist management
- [crane — cli/behaviours/system](./system/README.md) — Gherkin scenarios for crane-cli system-level commands
