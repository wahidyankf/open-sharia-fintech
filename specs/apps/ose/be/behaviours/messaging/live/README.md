...
in-process Unit proof through injected ports and are E2E-tested by `ose-be-e2e`. The owner's static
coverage includes this directory recursively; scenario-level Integration exemptions document why
the zero-network Integration boundary cannot express the broker interaction.
