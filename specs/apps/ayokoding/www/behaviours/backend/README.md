...
```
specs/apps/ayokoding/www/behaviours/backend/
...
[www/behaviours/frontend/](../frontend/README.md). Both perspectives execute inside the
...
- **Web counterpart**: [frontend behaviours](../frontend/README.md)
