...
See [Checking By-Example Format — Count, Density, Structure, Self-Containment](../../.claude/skills/docs-creating-by-example-tutorials/reference/checking-density-structure-containment.md)
and [Checking By-Example Format — Grouping, Compliance, Diagrams, Examples-by-Level](../../.claude/skills/docs-creating-by-example-tutorials/reference/checking-grouping-compliance-and-diagrams.md)
