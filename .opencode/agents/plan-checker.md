...
Accuracy Step 4b), and 21 numbered validation rules covering Operational Readiness, Manual Behavioural
...
for links, maps, word budgets, formatting, and Mermaid mechanics instead of rederiving those
predicates. Treat project-local `test:coverage:behaviour` as delivery evidence for static corpus,
adapter, exemption, and journey-shape checks; semantic Gherkin journey review remains in scope.
