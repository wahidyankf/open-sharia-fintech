...
- [08 Fix Completeness Scope](./fix-completeness-scope.md) — fixing every site of the same defect rather than only the ones a finding happened to cite, and what the reply must then state
