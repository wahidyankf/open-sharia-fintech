...
- [19 Manual Ui And Api Verification](./manual-ui-and-api-verification.md) — mandatory manual UI (Playwright) and API (curl) behavioral assertion sections
...
- [23 Plan Archival](./plan-archival.md) — the mandatory plan archival section every delivery plan must end with
- [24 Common Mistakes](./common-mistakes.md) — common plan-authoring mistakes, starting with missing acceptance criteria
  </content>
