...
- [01-thread-enumeration-and-api-gotchas.md](./reference/01-thread-enumeration-and-api-gotchas.md) —
  GraphQL enumeration query, and three confirmed live-API gotchas (pull_number requirement, `-F`
  vs `-f`, zsh 1-indexed loops)
- [02-four-way-triage.md](./reference/02-four-way-triage.md) — the fix / reject / defer / clarify
  decision table and each path's requirements
- [03-reply-resolve-discipline.md](./reference/03-reply-resolve-discipline.md) — hard rules for
  when a thread may actually be resolved, plus repeated-finding handling across cycles
- [04-identity-and-quality-gates.md](./reference/04-identity-and-quality-gates.md) — posting
