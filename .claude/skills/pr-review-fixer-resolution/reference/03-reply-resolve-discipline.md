...
- **Resolve only what was actually addressed** — call the `resolveReviewThread` GraphQL mutation
  ...
  [02-four-way-triage.md](./02-four-way-triage.md). Never resolve a `defer` or `clarify` thread
...
six and seven; see
[Loop-Exit and Block Rules](../../../../repo-governance/workflows/pr/pr-review-quality-gate/13-loop-exit-and-block-rules.md#loop-exit-and-block-rules).
