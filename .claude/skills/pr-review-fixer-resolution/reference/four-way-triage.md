...
**A reply teaches too**: say why the change resolves the finding, name the reviewed head and
evidence, and end with the canonical `Generated by AI` footer. See
...
evidence does not establish the finding — the cited line no longer matches behaviour, the rule
