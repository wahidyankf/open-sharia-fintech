...
See [21-knowledge-capture-scaffold-and-entries.md](21-knowledge-capture-scaffold-and-entries.md) and [22-knowledge-capture-phase-template.md](22-knowledge-capture-phase-template.md) for the mandatory phase that precedes archival, and [24-common-mistakes.md](24-common-mistakes.md) for authoring pitfalls to avoid before reaching this section.
