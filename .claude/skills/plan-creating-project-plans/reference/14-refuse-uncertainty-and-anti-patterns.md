...
When verification (see [13-verification-recipes.md](13-verification-recipes.md)) fails or is impossible: REFUSE to write the claim as a fact. Acceptable refusals:
