...
[23-plan-archival.md](23-plan-archival.md)) — that triages the plan's transient `learnings.md`
...
See [22-knowledge-capture-phase-template.md](22-knowledge-capture-phase-template.md) for the phase
