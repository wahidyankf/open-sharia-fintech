...
- [01-surface-profile-trees.md](reference/01-surface-profile-trees.md) — the four surface-profile
  directory trees (full-stack, web-only, cli-only, multi-cli) and when each folder is created
- [02-content-generation.md](reference/02-content-generation.md) — README inference, Gherkin
  feature file generation, C4 Mermaid diagram generation, DDD artifact scaffolding
- [03-conventions.md](reference/03-conventions.md) — the PM-readability contract, feature file
