...
1. [01-core-validation-and-agent-duplication.md](reference/01-core-validation-and-agent-duplication.md)
   and [02-skills-duplication-and-report-formats.md](reference/02-skills-duplication-and-report-formats.md) —
...
2. [03-word-budget-and-rules-governance-core.md](reference/03-word-budget-and-rules-governance-core.md)
   and [04-rules-governance-licensing-and-dependency-policy.md](reference/04-rules-governance-licensing-and-dependency-policy.md) —
...
3. [05-software-docs-validation-8-1-to-8-4.md](reference/05-software-docs-validation-8-1-to-8-4.md)
   and [06-software-docs-validation-8-5-to-8-8.md](reference/06-software-docs-validation-8-5-to-8-8.md) —
...
4. [07-preflight-consumption.md](reference/07-preflight-consumption.md) and
   [08-execution-sequence-and-report-structure.md](reference/08-execution-sequence-and-report-structure.md) —
