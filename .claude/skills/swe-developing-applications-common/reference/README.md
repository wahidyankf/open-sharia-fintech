...
- [Pre Commit Automation](./pre-commit-automation.md) — the automated pre-commit quality gates
- [Reference Docs And Tdd](./reference-docs-and-tdd.md) — standard project documentation patterns and TDD
- [Related Conventions](./related-conventions.md) — related workflow conventions
- [Tool Usage And Workflow Pattern](./tool-usage-and-workflow-pattern.md) — tool usage and the shared development workflow pattern
  </content>
