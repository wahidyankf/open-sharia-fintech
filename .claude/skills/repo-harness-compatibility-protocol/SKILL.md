...
- [01-phase0-parity-invariants.md](./reference/01-phase0-parity-invariants.md) — the five
  ...
  human-required)
- [02-phase1-drift-dimensions.md](./reference/02-phase1-drift-dimensions.md) — the seven
  dimensions (D1–D7), each with drift indicator/criticality AND fix target/action
- [03-checker-workflow-and-format.md](./reference/03-checker-workflow-and-format.md) — the
  checker's own workflow steps, research delegation pattern, and finding format
- [04-fixer-workflow-and-format.md](./reference/04-fixer-workflow-and-format.md) — the fixer's
  own confidence re-validation, process summary, fix report format, and FALSE_POSITIVE
  carry-forward
