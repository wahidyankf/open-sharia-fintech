...
- [Apps Wahidyankf Www Deployer](./apps-wahidyankf-www-deployer.md) — Deploys wahidyankf-web to production environment branch (prod-wahidyankf-www) after validation. Vercel listens to production branch for automatic builds.
