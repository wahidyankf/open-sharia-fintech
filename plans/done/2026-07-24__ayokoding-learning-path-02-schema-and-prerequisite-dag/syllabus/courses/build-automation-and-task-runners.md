# Build Automation and Task Runners (By Example, multi-tool)
...
[`13-just-enough-typescript`](./just-enough-typescript.md) project + a compiled artifact). Wiring a
build tool into a pipeline is [`55-cicd-and-release-engineering`](./cicd-and-release-engineering.md);
...
- **Prior topics**: [topic 5 Just Enough Bash](./just-enough-bash.md) (recipes are shell commands),
  [topic 6 Version Control & Git](./version-control-and-git.md) (tracked source files are the build
  inputs), and [topic 13 Just Enough TypeScript](./just-enough-typescript.md) (a `package.json`
...
> _Content originated in the now-closed FS-SE plan (topic 54); it now lives here in
