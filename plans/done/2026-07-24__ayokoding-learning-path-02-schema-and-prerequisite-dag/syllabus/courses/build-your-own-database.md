# Build Your Own Database (By Example, Python)
...
[`36-database-internals-and-storage-engines`](./database-internals-and-storage-engines.md): that topic
...
- **Prior topics**: [topic 36 Database Internals & Storage Engines](./database-internals-and-storage-engines.md)
  (B-tree vs LSM, the write-ahead log, buffer pool, MVCC — the concepts this topic makes concrete) and
  [topic 10 SQL Essentials](./sql-essentials.md) (the query surface you build a tiny version of).
...
> _Content originated in the now-closed FS-SE plan (topic 91); it now lives here in
