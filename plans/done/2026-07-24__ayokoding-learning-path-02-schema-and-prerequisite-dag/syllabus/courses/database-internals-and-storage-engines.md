# Database Internals and Storage Engines (By Example, Python)
...
build-your-own-database pass at [`91-build-your-own-database`](./build-your-own-database.md). `†`:
...
- Early databases wrote updates in place and hoped a crash didn't strike mid-write; the write-ahead log
  ...
  the read/write balance — is exactly what [`91-build-your-own-database`](./build-your-own-database.md)
...
> _Content originated in the now-closed FS-SE plan (topic 36); it now lives here in
