# Technical Communication (Annotated-concept, — (concept, no code))
...
- **Prior topics**: [topic 9 Project Management](./project-management.md).
...
- Engineering teams learned the hard way that architecture lived only in senior engineers' heads and
  ...
  the decision records that [`42-software-architecture`](./software-architecture.md) formalizes.
...
> _Content originated in the now-closed FS-SE plan (topic 18); it now lives here in
