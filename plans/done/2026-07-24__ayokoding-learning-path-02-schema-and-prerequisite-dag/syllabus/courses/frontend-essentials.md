# Frontend Essentials (By Example, TypeScript)
...
[`47-advanced-frontend`](./advanced-frontend.md) (DD-11). WCAG AA intro here (Accessibility First).
...
- **Prior topics**: [topic 13 Just Enough TypeScript](./just-enough-typescript.md) (all UI code is
  typed TS); applied testing cross-refs [topic 15 Software Testing](./software-testing.md).
...
> _Content originated in the now-closed FS-SE plan (topic 14); it now lives here in
