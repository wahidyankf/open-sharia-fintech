# Software Testing (By Example, Python + TypeScript)
...
[`30-software-engineering-practices`](./software-engineering-practices.md). This topic underpins the
...
- **Prior topics**: [topic 4 Just Enough Python](./just-enough-python.md) and
  [topic 13 Just Enough TypeScript](./just-enough-typescript.md) (examples span both);
  [topic 11 Backend Essentials](./backend-essentials.md) provides the app the integration test targets.
...
> _Content originated in the now-closed FS-SE plan (topic 15); it now lives here in
