...
| -------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Legacy-versus-Fluid billing vocabulary                         | Routed to the existing [steady-state successor](../../ideas/q4-not-urgent-not-important/vercel-cost-steady-state-verification.md), which owns the completed-cycle line-item check. |
...
| A check can pass while observing nothing                       | Folded into [acceptance-clause-vacuity](../../ideas/q1-urgent-important/acceptance-clause-vacuity.md), including the telemetry-order example.                                      |
| A spoofed identity cannot test an identity-verifying control   | Folded into [acceptance-clause-vacuity](../../ideas/q1-urgent-important/acceptance-clause-vacuity.md).                                                                             |
...
| A dashboard action can be assigned to the wrong control plane  | Folded into [acceptance-clause-vacuity](../../ideas/q1-urgent-important/acceptance-clause-vacuity.md).                                                                             |
| Aggregate telemetry was disabled before a later aggregate gate | Folded into [acceptance-clause-vacuity](../../ideas/q1-urgent-important/acceptance-clause-vacuity.md); the successor carries the deliberately deferred measurement.                |
