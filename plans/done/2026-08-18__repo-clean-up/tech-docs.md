...
│   └── swe-developing-applications-common/reference/nx-monorepo-integration.md [E] — rust-commons as a naming example
...
│   ├── ideas/q2-not-urgent-important/beavernest-first-deploy.md [E] — rebased off the deleted app onto beavernest-app
│   ├── ideas/q4-not-urgent-not-important/{beavernest-first-llm-integration,beavernest-be-nullbyte-path-error-envelope}.md [E] — same rename
│   ├── ideas/q2-not-urgent-important/coverage-artifact-relative-paths.md [E] — stale libs/ listing named rust-commons
│   ├── ideas/q2-not-urgent-important/ayokoding-course-root-overview-parity.md [N] — the 23 missing course-root overviews
