...
| 2   | "Leftover from the old stack" was wrong                                                                                                                                | **Discarded** — the [Repo-Grounding Rule](../../../repo-governance/development/quality/plan-anti-hallucination/repo-grounding-rule-hard.md) already forbids the unverified claim; routing it would change no durable surface, so it fails the litmus |
...
| 8   | Git pathspec globs do not cross `/`                                                                                                                                    | **Routed inline** into [`trustworthy-measurement` Rule 1](../../../repo-governance/development/practice/trustworthy-measurement/rule-1-prove-the-command-ran.md), which already collects the false-zero family                                       |
