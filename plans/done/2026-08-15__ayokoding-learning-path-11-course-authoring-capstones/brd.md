...
eight bands' unrelated delivery sequences.
...
| Risk                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Mitigation                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **A capstone cites a course body that is absent from the repository.**                                                                                                                                                                                                                                                                                                                                                                                                         | Phase 0 records repository context; the plan itself starts only after plan 10. Individual course-body checks verify cited artifacts immediately before authoring.                                                                                                                                                                                                                                                                                                             |
...
| **`vercel-function-cost-reduction` changes the exact app/route tree this plan's 8 new pages render into.** Authoring against the pre-fix dynamic-rendering shape risks the new pages inheriting the cost problem that plan is actively fixing.                                                                                                                                                                                                                                 | Treated as a repository-baseline check with a concrete, falsifiable checkable signal (root layout promoted, middleware deleted, no server-side `searchParams` read remaining) rather than a soft "should probably land first" assumption — see [README.md §Why the cost-reduction dependency is hard](./README.md#depends-on).                                                                                                                                                |
