...
[`acceptance-clause-vacuity`](./acceptance-clause-vacuity.md) covers the same failure class from the
acceptance-clause angle, and
[`mermaid-validator-does-not-check-syntax`](./mermaid-validator-does-not-check-syntax.md) covers it
...
- **`mermaid-validator-does-not-check-syntax`** — a validator cited as the correctness gate that
  ...
  [brief](./mermaid-validator-does-not-check-syntax.md)
