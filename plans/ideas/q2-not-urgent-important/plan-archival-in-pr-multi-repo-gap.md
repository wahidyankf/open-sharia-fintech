...
- **The Plan-Docs-Only Carve-Out** — the existing partial mitigation this plan leans on for its
  ...
  non-precedent.
  [plan-planning.md §The Plan-Docs-Only Carve-Out](../../../repo-governance/workflows/plan/plan-planning.md#the-plan-docs-only-carve-out-superseded--retired-in-three-of-four-repos)
