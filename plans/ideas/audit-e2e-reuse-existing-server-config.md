...
- [`ci-checker` agent](../../.claude/agents/ci-checker.md) — already validates projects against CI
...
- [`ayokoding-www-e2e-parallel-load-flake`](./ayokoding-www-e2e-parallel-load-flake.md) — a sibling
