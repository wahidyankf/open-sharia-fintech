...
shape as [mermaid-validator-does-not-check-syntax](./mermaid-validator-does-not-check-syntax.md): the
...
- **[tri-repo-rhino-cli-byte-identity-gate](./tri-repo-rhino-cli-byte-identity-gate.md)** — the
