...
| Repository state has drifted from the historical source descriptions.                                  | Phase 0 uses the sole direct predecessor archive check plus repository-baseline verification; historical plans do not create additional start gates.                                                                                                                                                                                                         |
