...
| Keep code changes outside this documentation program.                               | A required Rhino code/spec change becomes a separately planned prerequisite; this plan may only coordinate byte-identical documentation edits. |
