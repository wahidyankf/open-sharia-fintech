...
- [ ] `[PUB-REPAIR:P5.17][AI]` Record recheck evidence; only a clean successful repair authorizes `PUB-IDEAS-4`, while an evidenced failure keeps it frozen and opens only its new named repair path.
