...
- [ ] `[ACTIVATE:A0.05][AI]` Post and read back the complete matrix in the ACTIVATE PR artifact with `Generated by AI`; acceptance is every row directly evidenced or reasoned `N/A`, zero unresolved blocker, and no undisposed row.
