...
| [Repo-grounded] WAVES-RULES                                                         | #266 merged; author A3/B/C public/private checklists         |
| [Unverified] Complete assembled plan                                                | Fresh formal gate still precedes explicit activation         |

> **AUTHORING-ONLY UNTIL ACTIVATE:** WAVES-RULES changes plan docs only; it runs no
...
Plan assembly is deliberately **dormant and non-executable**. WAVES-RULES may change
...
FOUNDATION through WAVES-A are merged; WAVES-RULES is active. ACTIVATE
