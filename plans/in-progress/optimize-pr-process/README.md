...
**In Progress (WAVES-ENTRY active, authoring only); dormant until ACTIVATE.**
[Repo-grounded] WAVES-SPLIT PR [#257](https://github.com/wahidyankf/ose-public/pull/257) merged as
`aa5f14f768d0a8c4e0877d8aab7135b4d7529135`. WAVES-ENTRY now authors the entry contract,
repository baselines and repairs, idea-retirement units, correction firewall adapter, and sole
plan-amendment adapter. It executes none of them and leaves A1–B, C, closure, and the formal gate
dormant.
