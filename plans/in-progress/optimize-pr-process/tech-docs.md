...
### PRE-A1-ADMISSION Exact Public Ledger

The strict dry run at public pin `70dbe4187dd720d8fe344960d227c44cf3d549f5` is recorded in
`generated-reports/repo-rules-propagation__2026-08-24__pre-a1-admission__manifest.md`. This table
is its tracked admission result: every listed path is an exact future candidate, not permission to
edit it before its named unit. No private path is admitted here.

| Unit             | Exact hand-authored candidate paths                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Generated paths                                                                                  | Owner and bounded outcome                                                                                                                 |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------- |
| PUB-A1 / PRIV-A1 | _None._ Existing plan-boundary, one-worktree, atomic binding, and cross-repository obligation rules remain authoritative.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | None                                                                                             | Record evidence-backed `N/A`; do not open an empty rule PR or duplicate a category list.                                                  |
| PUB-A2           | `repo-governance/workflows/pr/pr-review-quality-gate/steps-0-1-classify-and-scout.md`; `loop-algorithm.md`; `loop-exit-and-block-rules.md`; `purpose-execution-mode-and-classifier.md`; `route-specific-done-definition.md`; `probe-variation-and-exit.md`; `notes.md`; `.claude/agents/pr-review/pr-review-scout-maker.md`; `.claude/skills/pr-review-scout-classification/reference/shared-context-and-prior-cycle-read.md`; `.claude/skills/pr-review-scout-classification/reference/risk-tier-and-specialist-selection.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Generated counterparts of the three `.claude/**` sources only, discovered by binding generation. | Add one pre-fan-out route record and bounded-cycle policy without widening the existing scope guard.                                      |
| PUB-A3           | `repo-governance/conventions/structure/plans/prs-open-at-delivery-boundaries-pr-body.md`; `.github/pull_request_template.md`; `repo-governance/development/quality/pr-review-disciplines/review-as-teaching.md`; `repo-governance/workflows/pr/pr-review-quality-gate/github-reviews-api-mechanics-part-1.md`; `github-reviews-api-mechanics-part-2.md`; `.claude/skills/pr-review-fixer-resolution/reference/four-way-triage.md`; `reply-resolve-discipline.md`; `identity-and-quality-gates.md`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Generated counterparts of the three fixer-resolution `.claude` sources only.                     | Make bodies and native review conversations human-readable without duplicating compatible scope/marker rules.                             |
