...
| PRIV-A1 | None before `PRIV-ADMISSION` publishes exact private counterparts from public pin `539cda50e6aa48079d347ae6131b81901120cd84`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | None                                                                    | It must publish a private-safe semantic adaptation, reasoned deviation, or `N/A`; it cannot infer edit authority from PUB-A1.             |
...
PR #289 supplies public provenance only; the PR #290 terminal handoff creates the sole actionable
private obligation after its reader-state receipt. `PRIV-ADMISSION` independently classifies semantic
counterparts at pin `539cda50e6aa48079d347ae6131b81901120cd84` and receives no public-path authority.
