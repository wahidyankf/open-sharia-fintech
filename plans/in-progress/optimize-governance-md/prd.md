...
(`ose-public`) / Phase 16 (`ose-private`) arming step, per the user decision recorded in FR-3.7
...
| FR-3.7  | Covered trees for `governance-readme-completeness` (`missing`/`unannotated`): `repo-governance/`, `.claude/`, `.codex/`, `.pi/`. Originally scoped wider, also adding `docs/` and `specs/`; narrowed to this 4-entry list at the Phase 9 (`ose-public`) / Phase 16 (`ose-private`) arming step by user decision — word/readme-budget gates exist to optimize agent context, not to police human-facing documentation (`delivery.md`'s Phase 9 execution log)                                                                                                                                                                                                                                                                         |
