...
- [x] [AI] Update `.claude/agents/swe/README.md` and `.claude/skills/README.md` with annotated index
      ...
      <!-- DU2-090: added "- [Swe Java Dev](./swe-java-dev.md) — <description>" to
      .claude/agents/swe/README.md and "- [Swe Programming Java](./swe-programming-java/README.md)
      — Java coding standards" to .claude/skills/README.md, each inserted alphabetically between
