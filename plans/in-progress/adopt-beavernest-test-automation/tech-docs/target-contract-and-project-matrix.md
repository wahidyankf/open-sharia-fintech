...
| `wahidyankf-www`           | application/site                | `specs/apps/wahidyankf/www/behaviors`                                      | required               | local app integration                                      | delegated to `wahidyankf-www-fe-e2e`        |
| `wahidyankf-www-fe-e2e`    | dedicated E2E                   | owner is `wahidyankf-www`                                                  | N/A                    | N/A                                                        | required                                    |
