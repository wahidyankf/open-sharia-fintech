# 10 · Take-Home & Live Coding (By Example, Python)

**Mapping row** (frozen [tech-docs §Canonical Mapping Table](../tech-docs.md#canonical-mapping-table)):
N=10 · Phase 1 · Interview Preparation · By Example · Python · folder weight 200 / learn 110 / drill 210. **NEW (interview module)**.
...
task). Complements [N=9 Coding Interview](./09-coding-interview.md): that module drills isolated
algorithmic problems; this one drills _shipping a small piece of real software under evaluation_. A
refresh for the experienced re-entrant.
...
- **Prior topics**: [N=4 Just Enough Python](./README.md), [N=5 Just Enough Bash](./README.md),
  [N=6 Version Control & Git](./README.md), and [N=9 Coding Interview](./09-coding-interview.md).
...
- Take-homes emerged as a fairer, lower-pressure complement to the whiteboard: they test the skills the
  ...
  capstone](./16c-capstone-interview-loop.md) and drawing on the raw-form-first editor fluency from the
  [prologue](./03c-capstone-forge-ready.md).
...
← Previous: [N=9 · Coding Interview](./09-coding-interview.md) · Next: N=11
`object-oriented-programming-essentials` ([index](./README.md)) →
