# 74 · Agent Orchestration, Subagents & Observability (Annotated-concept, Python)

**Mapping row** (frozen [tech-docs §Canonical Mapping Table](../tech-docs.md#canonical-mapping-table)):
N=74 · Phase 3 · Deepening (AI & harness engineering — harness cluster) · Annotated-concept · Python ·
folder weight 840 / learn 174 / drill 274. **NEW (Addition 2)** — last module of the harness cluster
before the [coding-agent capstone](./74c-capstone-build-your-own-coding-agent.md). Cluster language
**Python** (DN-12).
...
- **Prior topics**: [N=70 The Agent Loop](./70-the-agent-loop.md),
  ...
  [N=44 Concurrency & Parallelism](./README.md) for coordination; [N=65 Software Engineering
  Practices](./README.md) for evals-as-tests thinking.
...
- As agents took on larger tasks, the single-loop model strained: context filled, work was serial, and
  ...
  module caps the harness cluster ([N=70–73](./70-the-agent-loop.md)) and is the immediate prerequisite
  for the [build-your-own-coding-agent capstone](./74c-capstone-build-your-own-coding-agent.md).
...
9. **ex-33 · hook-driven-audit** — use a hook to build the audit log from
   [N=73](./73-agent-permissions-and-sandboxing.md) — verify completeness. (co-11)
...
← Previous: [N=73 · Agent Permissions & Sandboxing](./73-agent-permissions-and-sandboxing.md) · Next:
[capstone-build-your-own-coding-agent](./74c-capstone-build-your-own-coding-agent.md) →
