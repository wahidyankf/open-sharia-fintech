...
flowchart LR
    P04["ayokoding-learning-path-04<br/>course-authoring<br/>(remaining 8 bands)"]:::sibling
...
| **blockedBy**   | `ayokoding-learning-path-04-course-authoring`                                            | hard — needs its Phase 0 baseline and its Phase 1 (the six net-new AI-engineering courses) already merged to `origin/main`; `creating-ai-powered-apps` (course 8) and `agentic-ai` (course 9) here build on that foundation |
