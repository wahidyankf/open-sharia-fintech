# Type Systems (By Example, OCaml + Haskell + F#)
...
- **Prior topics**: [topic 23 Functional Programming](./functional-programming.md) (immutability, pure
  functions, HOFs), [topic 22 Programming Paradigms](./programming-paradigms.md) (typed-functional as one
  paradigm among several), and [topic 13 Just Enough TypeScript](./just-enough-typescript.md)
...
> _Content originated in the now-closed FS-SE plan (topic 88); it now lives here in
