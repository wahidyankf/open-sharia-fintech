# Data Engineering (Annotated-concept, Python)
...
[`26-advanced-sql-and-query-performance`](./advanced-sql-and-query-performance.md); the AI/RAG data
path is [`56-creating-ai-powered-apps`](./creating-ai-powered-apps.md).
...
- **Prior topics**: [topic 10 SQL Essentials](./sql-essentials.md) + [topic 26 Advanced SQL](./advanced-sql-and-query-performance.md)
  (the warehouse target, star schema, window functions), and [topic 4 Just Enough Python](./just-enough-python.md).
...
> _Content originated in the now-closed FS-SE plan (topic 37); it now lives here in
