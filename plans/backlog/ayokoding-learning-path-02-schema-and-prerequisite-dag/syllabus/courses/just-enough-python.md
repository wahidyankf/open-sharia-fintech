# Just Enough Python (Primer, Python)
...
[`08-object-oriented-programming-essentials`](./object-oriented-programming-essentials.md). Python is
...
> _Content originated in the now-closed FS-SE plan (topic 4); it now lives here in
