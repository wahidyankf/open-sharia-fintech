...
[`89-compilers-parsers-and-transpilers`](./compilers-parsers-and-transpilers.md). The `dotnet` F#
...
- **Prior topics**: [topic 23 Functional Programming](./functional-programming.md) (immutability, pure
  ...
  [topic 8 Object-Oriented Programming Essentials](./object-oriented-programming-essentials.md) (F# is
...
> _Content originated in the now-closed FS-SE plan (topic 87); it now lives here in
