# Linux App Development (By Example, Python)
...
teaching language here). The kernel-level view is [`79-linux-os`](./linux-os.md).
...
- **Prior topics**: [topic 4 Just Enough Python](./just-enough-python.md),
  [topic 5 Just Enough Bash](./just-enough-bash.md) (env/args/exit codes/
  signals), and [topic 11 Backend Essentials](./backend-essentials.md) (long-running service intuition).
...
> _Content originated in the now-closed FS-SE plan (topic 76); it now lives here in
