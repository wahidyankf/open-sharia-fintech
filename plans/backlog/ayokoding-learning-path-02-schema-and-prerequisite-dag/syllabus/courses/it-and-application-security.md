# IT and Application Security (Annotated-concept, Python)
...
security topics — [`59-offensive-security`](./offensive-security.md) and
[`60-defensive-security`](./defensive-security.md) — and it deepens
[`17-security-essentials`](./security-essentials.md).
...
- **Prior topics**: [topic 17 Security Essentials](./security-essentials.md) (auth, hashing, injection
  basics), [topic 39 Backend at Scale](./backend-at-scale.md) (OAuth2/OIDC, the surface to secure), and
...
- The engineering-security canon is scar tissue from public breaches. The CIA triad and defense-in-depth come
  ...
  into the hands-on red/blue topics [`59-offensive-security`](./offensive-security.md) and
  [`60-defensive-security`](./defensive-security.md).
...
> _Content originated in the now-closed FS-SE plan (topic 58); it now lives here in
