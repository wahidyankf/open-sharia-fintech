# IT Governance (GRC) (Annotated-concept, — (concept, no code))
...
concepts), policy vs control, audit trails, and how security posture ([`58-it-and-application-security`](./it-and-application-security.md),
[`60-defensive-security`](./defensive-security.md)) rolls up into organizational assurance. Deliverables
...
- **Prior topics**: [topic 58 IT / Application Security](./it-and-application-security.md) (CIA, threat modeling, controls),
  [topic 60 Defensive Security](./defensive-security.md) (detection, IR, the blue-team view that GRC
  rolls up), and [topic 9 Project Management](./project-management.md)
...
> _Content originated in the now-closed FS-SE plan (topic 62); it now lives here in
