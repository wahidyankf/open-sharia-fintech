# Networking Essentials (By Example, Python)
...
`tcpdump` analysis go to [`29-advanced-networking`](./advanced-networking.md) (DD-11).
...
- **Prior topics**: [topic 4 Just Enough Python](./just-enough-python.md) (socket examples are
  Python).
...
> _Content originated in the now-closed FS-SE plan (topic 12); it now lives here in
