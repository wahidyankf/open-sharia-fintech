# Build Your Own Git (By Example, Python)
...
each other's output. This is the build-your-own tier of [`06-version-control-and-git`](./version-control-and-git.md):
...
- **Prior topics**: [topic 6 Version Control & Git](./version-control-and-git.md) (the object-model
  intuition — commits/trees/blobs/refs — and everyday CLI fluency this topic makes concrete) and
  [topic 4 Just Enough Python](./just-enough-python.md) (the implementation language).
...
- Before Git, version control (CVS, then Subversion) tracked file-by-file deltas against a central
  ...
  [`06-version-control-and-git`](./version-control-and-git.md)'s porcelain commands from memorized
...
> _Content originated in the now-closed FS-SE plan (topic 90); it now lives here in
