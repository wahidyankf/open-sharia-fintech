# Analytics and Experimentation (By Example, Python)
...
[`10-sql-essentials`](./sql-essentials.md) and the discipline of a controlled comparison extends
[`15-software-testing`](./software-testing.md). Pulled earlier in the spiral because its prerequisites
...
- **Prior topics**: [topic 10 SQL Essentials](./sql-essentials.md) (aggregation, joins, and
  group-by over event tables) and [topic 15 Software Testing](./software-testing.md) (the mindset of a
...
- Controlled experimentation descends from R. A. Fisher's agricultural randomized trials and the clinical
  ...
  [`77-building-production-cli-tools`](./building-production-cli-tools.md).
...
> _Content originated in the now-closed FS-SE plan (topic 63); it now lives here in
