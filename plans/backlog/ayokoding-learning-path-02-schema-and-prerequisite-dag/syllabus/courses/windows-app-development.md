# Windows App Development (By Example, C#)
...
- **Prior topics**: [topic 74 Just Enough C#](./just-enough-csharp.md) (the language + `async`/`await`),
  [topic 14 Frontend Essentials](./frontend-essentials.md) (component + state UI, MVVM intuition), and
  [topic 47 Advanced Frontend](./advanced-frontend.md) (data binding, state management).
...
> _Content originated in the now-closed FS-SE plan (topic 75); it now lives here in
