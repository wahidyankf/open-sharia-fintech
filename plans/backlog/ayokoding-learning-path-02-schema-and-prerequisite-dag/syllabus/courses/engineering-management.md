# Engineering Management (Annotated-concept, — (concept, no code))
...
[topic 30 Software Engineering Practices](./software-engineering-practices.md) thread arrives here. Deliverables are **leadership/
...
now anchors at the journey's true close, [`94-site-reliability-engineering`](./site-reliability-engineering.md)).
...
- **Prior topics**: [topic 30 Software Engineering Practices](./software-engineering-practices.md) (the
  engineering practices a lead upholds and scales across a team), [topic 32 Software Product Engineering](./software-product-engineering.md)
  (strategy, prioritization, product partnership), and [topic 9 Project Management](./project-management.md)
...
- Engineering management professionalized as teams outgrew the heroic-lead / player-coach model that
  ...
  Pass 2 on `coupling-vs-cohesion` at org scale, pairs with [`32-software-product-engineering`](./software-product-engineering.md)
  (what to build) and [`09-project-management`](./project-management.md) (deliver it), and matures into
  the org-level reliability trade-offs of [`94-site-reliability-engineering`](./site-reliability-engineering.md).
...
> _Content originated in the now-closed FS-SE plan (topic 33); it now lives here in
> full — this course block is self-contained._

## In which paths — `capstone-solid-core` (DD-20)

- `interview-ready/software-engineer` — Go deeper · AI & harness engineering — placed right after
  `capstone-build-your-own-coding-agent` (its latest prerequisite, `software-engineering-practices`,
  precedes it there).
- `immediately-effective/software-engineer` — Deepening band · AI & harness engineering — placed right
  after `capstone-build-your-own-coding-agent`, same rationale.
- `fundamentally-strong/software-engineer` — Stage 12 · AI & harness engineering — placed right after
  `capstone-build-your-own-coding-agent`, before Stage 13 · Security suite (its downstream dependent,
  `capstone-real-world-delivery`, needs both `capstone-solid-core` and `defensive-security` — Stage 13
  — so `capstone-solid-core` must land no later than the end of Stage 12).
