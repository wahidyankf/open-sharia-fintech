# Just Enough Swift (Primer, Swift)
...
[`71-ios-app-development`](./ios-app-development.md), taught from the `swift` REPL / `swiftc` CLI
...
- **Prior topics**: [topic 8 Object-Oriented Programming Essentials](./object-oriented-programming-essentials.md) (types,
  classes) and [topic 68 Just Enough Kotlin](./just-enough-kotlin.md) (null-safety/optionals intuition
  transfers).
...
> _Content originated in the now-closed FS-SE plan (topic 70); it now lives here in
