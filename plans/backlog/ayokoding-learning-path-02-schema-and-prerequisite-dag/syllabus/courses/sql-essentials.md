# SQL Essentials (By Example, SQL + Python)
...
[`26-advanced-sql-and-query-performance`](./advanced-sql-and-query-performance.md) (DD-11). SQLite is
...
- **Prior topics**: [topic 4 Just Enough Python](./just-enough-python.md) (Python drives DB access).
...
> (prd-row Learn/Drill IDs `108/208`→`110/210` to match `prd.md`, a copy-paste artifact
...
> _Content originated in the now-closed FS-SE plan (topic 10); it now lives here in
