# Just Enough Kotlin (Primer, Kotlin)
...
[`69-android-app-development`](./android-app-development.md). The toolchain, syntax, null-safety,
...
- **Prior topics**: [topic 8 Object-Oriented Programming Essentials](./object-oriented-programming-essentials.md)
  ...
  [topic 13 Just Enough TypeScript](./just-enough-typescript.md) helps for null-safety intuition.
...
- **Coroutines preview** — kotlinlang.org `coroutines-basics.html`: a `suspend` function "allows a running
  ...
  [`69-android-app-development`](./android-app-development.md)). `[Verified]`
...
- **co-26 · coroutines-preview** — `suspend` functions pause and resume without blocking a thread;
  ...
  [`69-android-app-development`](./android-app-development.md)).
...
> _Content originated in the now-closed FS-SE plan (topic 68); it now lives here in
