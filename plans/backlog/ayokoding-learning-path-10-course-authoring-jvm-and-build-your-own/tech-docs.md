...
| `just-enough-go` now lives in `ayokoding-learning-path-05-course-authoring-platform-and-concurrency`                                                                          | `[Repo-grounded]` — this plan's dated archive exists under `plans/done/2026-08-04__ayokoding-learning-path-05-course-authoring-platform-and-concurrency/` and its `tech-docs.md:315` lists `just-enough-go` (`T(64)`, Primer, Go, prerequisites `—`). It remains a hard `blockedBy` precondition: execution must verify terminal PR #133 is merged and then confirm the course directory exists on the checked-out integration branch.                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
