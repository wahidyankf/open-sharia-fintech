...
| **blockedBy**   | [`ayokoding-learning-path-05-course-authoring-platform-and-concurrency`](../../done/2026-08-04__ayokoding-learning-path-05-course-authoring-platform-and-concurrency/README.md) | **Hard, satisfied.** `build-your-own-raft`'s prerequisite `just-enough-go` (Band 4) is delivered here.                                                                                                                                                                                                                      |
