...
- **A small, independently-shippable unit.** Eleven bodies in two delivery-boundary PRs is small enough
  to review, merge, and deploy on a short cycle, rather than waiting on the rest of the split family's
  other plans (`05`-`07`, `09`-`11`).
