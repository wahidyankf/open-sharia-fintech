...
work in `shell/`. That boundary makes content behavior easier to test without requiring a running
site.
...
npm exec nx -- run ayokoding-www:test:specs
```

Browser coverage lives in the sibling `apps/ayokoding-www-fe-e2e/` project. The accompanying
behavior specifications are in [the AyoKoding specs](../../specs/apps/ayokoding/README.md).
