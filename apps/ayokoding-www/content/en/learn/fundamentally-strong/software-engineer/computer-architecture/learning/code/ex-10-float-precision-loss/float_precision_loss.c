...
int main(void) {
  ...
  float large = 100000000.0f; // => co-13: 1e8 -- at the edge of float's
                              // ~7-digit precision
  float tiny =
      1.0f; // => co-13: would need a units-place digit float can't spare here
