...
test -f a.txt || { echo "FAIL: a.txt missing"; exit 1; }       # => step 1 must survive the revert of step 3
test -f b.txt || { echo "FAIL: b.txt missing"; exit 1; }       # => step 2 must survive the revert of step 3
test -f d.txt || { echo "FAIL: d.txt missing"; exit 1; }       # => step 4 must survive the revert of step 3
test ! -f c.txt || { echo "FAIL: c.txt still present"; exit 1; } # => step 3's own file must be gone -- that's the revert's whole point
