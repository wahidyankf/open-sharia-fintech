...
OpenClaw is distributed as an npm package requiring Node.js 22.19+ or 24+ (recommended). The CLI installs globally and provides the `openclaw` command for managing your local AI agent gateway.
