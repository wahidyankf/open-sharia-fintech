...
These guides follow the [In-the-Field Convention](https://github.com/wahidyankf/ose-public/blob/main/repo-governance/conventions/tutorials/in-the-field.md), which defines production implementation guide standards.
