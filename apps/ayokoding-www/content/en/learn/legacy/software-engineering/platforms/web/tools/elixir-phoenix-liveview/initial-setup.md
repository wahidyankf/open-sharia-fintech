...
This tutorial provides 0-5% coverage—just enough to get LiveView working in your Phoenix app. For deeper learning, continue to [Quick Start](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix-liveview/quick-start) (5-30% coverage).
...
- Basic Phoenix knowledge (routing, controllers, views) - see [Phoenix by Example](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix/by-example)
...
1. **[Quick Start](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix-liveview/quick-start)** - Build a complete LiveView feature with forms and validation
2. **[By Example](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix-liveview/by-example)** - Learn through 85 annotated code examples
...
**Next**: Try the [Quick Start](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix-liveview/quick-start) tutorial to build a real-world LiveView feature with forms, validation, and PubSub.
