...
This tutorial provides 0-5% coverage - just enough to get your shell environment working. For deeper learning, continue to [Quick Start](/en/learn/software-engineering/platforms/linux/tools/shell/quick-start) (5-30% coverage).
...
- [Quick Start](/en/learn/software-engineering/platforms/linux/tools/shell/quick-start) (5-30% coverage) - Touch all core shell concepts in a fast-paced tour
...
- [Overview](/en/learn/software-engineering/platforms/linux/tools/shell/overview) - Why command-line interfaces matter and when to use them
