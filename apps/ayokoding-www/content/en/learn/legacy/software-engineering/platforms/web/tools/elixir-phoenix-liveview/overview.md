...
1. **[Initial Setup](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix-liveview/initial-setup)** - Add LiveView to Phoenix app, create first LiveView
2. **[Quick Start](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix-liveview/quick-start)** - Complete counter example with step-by-step walkthrough (5-30% coverage)
3. **[By Example](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix-liveview/by-example)** - 85 annotated code examples covering 95% of LiveView features
...
- Phoenix framework basics (routing, controllers, views) - see [Phoenix by Example](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix/by-example)
...
**You must understand Phoenix basics before learning LiveView**. See [Phoenix by Example](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix/by-example) for Phoenix fundamentals.

## Next Steps

Choose your learning path:

- **[Initial Setup](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix-liveview/initial-setup)** - Add LiveView to existing Phoenix app
- **[Quick Start](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix-liveview/quick-start)** - Build your first LiveView (counter)
- **[By Example](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix-liveview/by-example)** - Learn through 85 annotated examples
