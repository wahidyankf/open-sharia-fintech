...
**[Quick Start](/en/learn/software-engineering/platforms/web/tools/jvm-spring/quick-start)** - Build a complete Zakat Calculator application demonstrating Spring Framework core features

**[By Example](/en/learn/software-engineering/platforms/web/tools/jvm-spring/by-example)** - Learn through heavily annotated code examples
