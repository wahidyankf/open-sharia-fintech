...
**[Initial Setup](/en/learn/software-engineering/platforms/web/tools/jvm-spring/initial-setup)** - Install Java/Kotlin, set up build tools, create project structure

**[Quick Start](/en/learn/software-engineering/platforms/web/tools/jvm-spring/quick-start)** - Build a complete Zakat Calculator application in 30 minutes

**[By Example](/en/learn/software-engineering/platforms/web/tools/jvm-spring/by-example)** - Learn through 75-90 heavily annotated code examples
