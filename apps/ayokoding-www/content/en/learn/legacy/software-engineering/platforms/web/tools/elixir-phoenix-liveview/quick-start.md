...
This tutorial provides 5-30% coverage—practical hands-on experience with essential LiveView features. For comprehensive learning, continue to [By Example](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix-liveview/by-example) (95% coverage).

## Prerequisites

Before starting this tutorial, you need:

- Phoenix LiveView installed and configured (see [Initial Setup](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix-liveview/initial-setup))
...
- Phoenix basics (routing, controllers) - see [Phoenix by Example](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix/by-example)
...
1. **[By Example](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix-liveview/by-example)** - 85 annotated examples covering 95% of LiveView
...
**Next**: Explore [By Example](/en/learn/software-engineering/platforms/web/tools/elixir-phoenix-liveview/by-example) for comprehensive 95% coverage through 85 annotated examples.
