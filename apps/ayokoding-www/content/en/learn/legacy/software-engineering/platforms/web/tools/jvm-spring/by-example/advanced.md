...
**Prerequisites**: Complete [Beginner](/en/learn/software-engineering/platforms/web/tools/jvm-spring/by-example/beginner) and [Intermediate](/en/learn/software-engineering/platforms/web/tools/jvm-spring/by-example/intermediate) tutorials first
