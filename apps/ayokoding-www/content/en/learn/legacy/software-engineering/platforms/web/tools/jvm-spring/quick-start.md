...
**[By Example](/en/learn/software-engineering/platforms/web/tools/jvm-spring/by-example)** - Learn through 75-90 heavily annotated examples covering:
...
**[Spring Boot Tutorial](/en/learn/software-engineering/platforms/web/tools/jvm-spring-boot)** - After mastering Spring Framework fundamentals, learn how Spring Boot simplifies configuration and deployment
