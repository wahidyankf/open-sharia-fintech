...
1. **[Initial Setup](/en/learn/software-engineering/platforms/linux/tools/shell/initial-setup)** - Configure shell environment, essential tools, verify your setup
2. **[Quick Start](/en/learn/software-engineering/platforms/linux/tools/shell/quick-start)** - Your first commands, basic navigation, essential patterns
...
Explore the [by-example section](/en/learn/software-engineering/platforms/linux/tools/shell/by-example) to begin your command-line journey, starting with fundamental operations and progressing to advanced shell scripting and automation techniques.
