...
Continue to [Intermediate](/en/learn/software-engineering/platforms/web/tools/fe-tanstack-start/by-example/intermediate) to learn server functions, authentication, TanStack Query integration, and production data patterns.
