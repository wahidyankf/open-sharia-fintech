...
This primer covers immutable values, pattern matching, modules, recursion, Enum, strings, and a small
preview of isolated BEAM processes. It prepares you for actor-model concurrency; supervision and OTP
belong in the next course.
