"""Runnable verification for CI/CD Example 60: Roll Back a Bad Canary Automatically."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-60-canary-auto-rollback",
    ...
    print(f"{evidence.identifier}: Verify that an unhealthy metric produces rollback. -> {is_verified(evidence)}")
