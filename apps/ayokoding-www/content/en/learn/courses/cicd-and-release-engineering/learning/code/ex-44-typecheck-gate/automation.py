"""Runnable verification for CI/CD Example 44: Gate on Pyright."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-44-typecheck-gate",
    ...
    print(f"{evidence.identifier}: Verify that the workflow invokes pyright against typed source. -> {is_verified(evidence)}")
