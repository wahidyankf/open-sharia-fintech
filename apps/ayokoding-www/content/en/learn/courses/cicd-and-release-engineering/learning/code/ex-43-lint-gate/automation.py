"""Runnable verification for CI/CD Example 43: Gate on Lint."""
...
def main() -> None:
    ...
    print(f"{evidence.identifier}: Verify that a failed lint result prevents the modeled promotion. -> {is_verified(evidence)}")
