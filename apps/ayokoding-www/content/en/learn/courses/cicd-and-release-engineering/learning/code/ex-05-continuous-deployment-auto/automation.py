"""Runnable verification for CI/CD Example 05: Automatic Deployment After Green."""
...
def main() -> None:
    ...
    check = Verification(
        ...
        name="ex-05-continuous-deployment-auto",
    ...
    print(f"{check.name}: Confirm the workflow has no approval step between a green verification and deployment. -> {passes(check)}")
