"""Runnable verification for CI/CD Example 56: Switch Blue-Green Traffic."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-56-blue-green-switch",
    ...
    print(f"{evidence.identifier}: Verify that the modeled active color changes in a single operation. -> {is_verified(evidence)}")
