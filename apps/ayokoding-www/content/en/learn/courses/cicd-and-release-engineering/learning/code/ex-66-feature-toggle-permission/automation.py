"""Runnable verification for CI/CD Example 66: Use a Permission Toggle."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-66-feature-toggle-permission",
    ...
    print(f"{evidence.identifier}: Verify that a non-entitled user is denied the path. -> {is_verified(evidence)}")
