"""Runnable verification for CI/CD Example 36: Factor a Composite Action."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-36-composite-action",
    ...
    print(f"{evidence.identifier}: Verify that the artifact runs the shared action rather than duplicating its command. -> {is_verified(evidence)}")
