"""Runnable verification for CI/CD Example 82: Drive a Flagger Progressive Delivery."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-82-flagger-progressive-delivery",
    ...
    print(f"{evidence.identifier}: Verify that the manifest records weighted steps and metric thresholds. -> {is_verified(evidence)}")
