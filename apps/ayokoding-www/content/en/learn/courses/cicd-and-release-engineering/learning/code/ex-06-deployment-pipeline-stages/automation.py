"""Runnable verification for CI/CD Example 06: Order a Deployment Pipeline."""
...
def main() -> None:
    ...
    check = Verification(
        ...
        name="ex-06-deployment-pipeline-stages",
    ...
    print(f"{check.name}: Confirm the automation preserves the stage order rather than skipping directly to deployment. -> {passes(check)}")
