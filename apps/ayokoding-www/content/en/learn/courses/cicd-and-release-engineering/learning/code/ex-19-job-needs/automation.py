"""Runnable verification for CI/CD Example 19: Sequence Jobs with Needs."""
...
def main() -> None:
    ...
    print(f"{check.name}: Confirm the deploy job names the test job in needs. -> {passes(check)}")
