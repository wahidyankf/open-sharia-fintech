"""Runnable verification for CI/CD Example 24: Require a Green Status Check."""
...
def main() -> None:
    ...
    print(f"{check.name}: Confirm the automation rejects an unsuccessful required check. -> {passes(check)}")
