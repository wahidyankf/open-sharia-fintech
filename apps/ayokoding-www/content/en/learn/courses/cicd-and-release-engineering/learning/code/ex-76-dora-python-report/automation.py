"""Runnable verification for CI/CD Example 76: Report DORA Metrics in Python."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-76-dora-python-report",
    ...
    print(f"{evidence.identifier}: Verify that the report emits all four named measures. -> {is_verified(evidence)}")
