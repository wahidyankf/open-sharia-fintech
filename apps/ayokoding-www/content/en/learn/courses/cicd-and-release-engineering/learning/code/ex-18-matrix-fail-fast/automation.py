"""Runnable verification for CI/CD Example 18: Control Matrix Fail-Fast Behavior."""
...
def main() -> None:
    ...
    print(f"{check.name}: Confirm the workflow explicitly sets both controls. -> {passes(check)}")
