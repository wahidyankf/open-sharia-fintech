"""Runnable verification for CI/CD Example 77: Promote One Immutable Artifact."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-77-promotable-artifact",
    ...
    print(f"{evidence.identifier}: Verify that every stage refers to the same digest. -> {is_verified(evidence)}")
