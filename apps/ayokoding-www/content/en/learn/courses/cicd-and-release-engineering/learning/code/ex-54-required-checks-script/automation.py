"""Runnable verification for CI/CD Example 54: Assert Required Checks in Python."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-54-required-checks-script",
    ...
    print(f"{evidence.identifier}: Verify that one failed required status makes the script report false. -> {is_verified(evidence)}")
