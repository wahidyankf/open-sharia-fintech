"""Runnable verification for CI/CD Example 70: Verify a Container Signature."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-70-cosign-verify",
    ...
    print(f"{evidence.identifier}: Verify that an unsigned artifact is rejected. -> {is_verified(evidence)}")
