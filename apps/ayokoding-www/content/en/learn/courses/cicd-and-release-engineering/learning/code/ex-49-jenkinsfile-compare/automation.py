"""Runnable verification for CI/CD Example 49: Compare a Jenkinsfile."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-49-jenkinsfile-compare",
    ...
    print(f"{evidence.identifier}: Verify that the comparison names the common version-control property. -> {is_verified(evidence)}")
