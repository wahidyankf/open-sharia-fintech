"""Runnable verification for CI/CD Example 35: Call a Reusable Workflow."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-35-reusable-workflow",
    ...
    print(f"{evidence.identifier}: Verify that the caller uses a reusable-workflow reference. -> {is_verified(evidence)}")
