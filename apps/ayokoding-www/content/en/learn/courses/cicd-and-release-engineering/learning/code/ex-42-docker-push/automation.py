"""Runnable verification for CI/CD Example 42: Push a Container Image."""
...
def main() -> None:
    ...
    print(f"{evidence.identifier}: Verify that the artifact models login as an external secret boundary and names a non-real image. -> {is_verified(evidence)}")
