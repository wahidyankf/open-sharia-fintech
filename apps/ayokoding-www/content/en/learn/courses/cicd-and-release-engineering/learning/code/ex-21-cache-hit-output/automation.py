"""Runnable verification for CI/CD Example 21: Branch on a Cache Hit."""
...
def main() -> None:
    ...
    print(f"{check.name}: Confirm the install step runs only when the cache-hit output is not true. -> {passes(check)}")
