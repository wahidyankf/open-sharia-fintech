"""Runnable verification for CI/CD Example 71: Gate on Provenance Verification."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-71-provenance-verify-gate",
    ...
    print(f"{evidence.identifier}: Verify that either missing evidence blocks promotion. -> {is_verified(evidence)}")
