"""Runnable verification for CI/CD Example 57: Roll Back Blue-Green Traffic."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-57-blue-green-rollback",
    ...
    print(f"{evidence.identifier}: Verify that the modeled router can switch back without rebuilding an artifact. -> {is_verified(evidence)}")
