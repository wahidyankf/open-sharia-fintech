"""Runnable verification for CI/CD Example 72: Measure Deployment Frequency."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-72-dora-deploy-frequency",
    ...
    print(f"{evidence.identifier}: Verify that the report counts production deployment records. -> {is_verified(evidence)}")
