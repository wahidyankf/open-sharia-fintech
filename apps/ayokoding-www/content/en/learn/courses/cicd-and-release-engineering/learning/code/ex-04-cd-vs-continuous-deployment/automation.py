"""Runnable verification for CI/CD Example 04: Continuous Delivery Versus Deployment."""
...
def main() -> None:
    ...
    check = Verification(
        ...
        name="ex-04-cd-vs-continuous-deployment",
    ...
    print(f"{check.name}: Confirm the artifact distinguishes the capability from the automatic-production policy. -> {passes(check)}")
