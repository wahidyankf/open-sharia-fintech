"""Runnable verification for CI/CD Example 83: Choose a Progressive Delivery Strategy."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-83-progressive-delivery-strategy-decision",
    ...
    print(f"{evidence.identifier}: Verify that the decision artifact records each strategy and its trade-off. -> {is_verified(evidence)}")
