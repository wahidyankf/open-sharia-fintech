"""Runnable verification for CI/CD Example 29: Map Conventional Commits to SemVer."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-29-conventional-to-semver",
    ...
    print(f"{evidence.identifier}: Verify that each representative commit produces the expected version category. -> {is_verified(evidence)}")
