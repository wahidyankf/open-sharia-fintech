"""Runnable verification for CI/CD Example 69: Sign a Container Image."""
...
def main() -> None:
    ...
    print(f"{evidence.identifier}: Verify that the signing model records a signature for the digest. -> {is_verified(evidence)}")
