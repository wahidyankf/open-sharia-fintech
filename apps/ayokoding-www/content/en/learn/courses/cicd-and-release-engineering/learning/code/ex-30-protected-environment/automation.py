"""Runnable verification for CI/CD Example 30: Protect a Production Environment."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-30-protected-environment",
    ...
    print(f"{evidence.identifier}: Verify that the deploy job names the production environment. -> {is_verified(evidence)}")
