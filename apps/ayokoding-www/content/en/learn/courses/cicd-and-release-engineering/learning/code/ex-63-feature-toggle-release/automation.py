"""Runnable verification for CI/CD Example 63: Use a Release Toggle."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-63-feature-toggle-release",
    ...
    print(f"{evidence.identifier}: Verify that the toggle keeps the unfinished path dark. -> {is_verified(evidence)}")
