"""Runnable verification for CI/CD Example 65: Use an Operations Toggle."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-65-feature-toggle-ops",
    ...
    print(f"{evidence.identifier}: Verify that the disabled state avoids the guarded feature path. -> {is_verified(evidence)}")
