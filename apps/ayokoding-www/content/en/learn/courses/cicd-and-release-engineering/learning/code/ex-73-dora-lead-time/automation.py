"""Runnable verification for CI/CD Example 73: Measure Change Lead Time."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-73-dora-lead-time",
    ...
    print(f"{evidence.identifier}: Verify that the model subtracts commit time from production time. -> {is_verified(evidence)}")
