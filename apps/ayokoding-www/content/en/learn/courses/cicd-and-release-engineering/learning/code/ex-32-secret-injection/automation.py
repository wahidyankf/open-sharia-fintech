"""Runnable verification for CI/CD Example 32: Inject a Secret Safely."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-32-secret-injection",
    ...
    print(f"{evidence.identifier}: Verify that the artifact references a placeholder secret name and never supplies a value. -> {is_verified(evidence)}")
