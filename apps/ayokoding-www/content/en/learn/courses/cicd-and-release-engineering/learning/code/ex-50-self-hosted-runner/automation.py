"""Runnable verification for CI/CD Example 50: Assess a Self-Hosted Runner."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-50-self-hosted-runner",
    ...
    print(f"{evidence.identifier}: Verify that the artifact records both control and upkeep. -> {is_verified(evidence)}")
