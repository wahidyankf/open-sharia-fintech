"""Runnable verification for CI/CD Example 17: Test a Python Version Matrix."""
...
def main() -> None:
    ...
    check = Verification(
        ...
        name="ex-17-matrix-python-versions",
    ...
    print(f"{check.name}: Confirm the matrix lists more than one Python version. -> {passes(check)}")
