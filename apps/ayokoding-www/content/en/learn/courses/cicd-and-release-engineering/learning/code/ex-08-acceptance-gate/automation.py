"""Runnable verification for CI/CD Example 08: Block Promotion on Acceptance Failure."""
...
def main() -> None:
    ...
    print(f"{check.name}: Confirm a failed acceptance result prevents the promotion outcome. -> {passes(check)}")
