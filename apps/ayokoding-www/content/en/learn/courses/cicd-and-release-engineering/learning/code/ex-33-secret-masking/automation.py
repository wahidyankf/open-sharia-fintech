"""Runnable verification for CI/CD Example 33: Mask a Sensitive Value."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-33-secret-masking",
    ...
    print(f"{evidence.identifier}: Verify that the artifact calls add-mask only for a supplied placeholder value. -> {is_verified(evidence)}")
