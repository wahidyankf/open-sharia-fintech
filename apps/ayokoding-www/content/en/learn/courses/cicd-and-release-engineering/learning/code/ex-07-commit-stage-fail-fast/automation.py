"""Runnable verification for CI/CD Example 07: Fail Fast in the Commit Stage."""
...
def main() -> None:
    ...
    check = Verification(
        ...
        name="ex-07-commit-stage-fail-fast",
    ...
    print(f"{check.name}: Confirm the recorded order puts quick validation before an expensive acceptance check. -> {passes(check)}")
