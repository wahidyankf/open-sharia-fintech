"""Runnable verification for CI/CD Example 45: Gate on Coverage."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-45-coverage-gate",
    ...
    print(f"{evidence.identifier}: Verify that a below-threshold result is modeled as a failing gate. -> {is_verified(evidence)}")
