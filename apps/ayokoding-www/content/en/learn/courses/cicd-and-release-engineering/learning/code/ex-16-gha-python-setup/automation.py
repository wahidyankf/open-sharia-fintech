"""Runnable verification for CI/CD Example 16: Set Up Python Before Tests."""
...
def main() -> None:
    ...
    print(f"{check.name}: Confirm the workflow configures Python and then runs the course-owned script. -> {passes(check)}")
