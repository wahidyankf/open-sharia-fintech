"""Runnable verification for CI/CD Example 27: Write a Conventional Commit."""
...
def main() -> None:
    ...
    check = Verification(
        ...
        name="ex-27-conventional-commit",
    ...
    print(f"{check.name}: Confirm the example commit follows the feat(scope): description shape. -> {passes(check)}")
