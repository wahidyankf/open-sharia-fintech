"""Runnable verification for CI/CD Example 25: Choose a Semantic Version Increment."""
...
def main() -> None:
    ...
    print(f"{check.name}: Confirm the artifact maps all three change kinds to their version component. -> {passes(check)}")
