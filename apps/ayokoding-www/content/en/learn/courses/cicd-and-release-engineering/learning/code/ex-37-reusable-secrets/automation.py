"""Runnable verification for CI/CD Example 37: Pass a Secret to a Reusable Workflow."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-37-reusable-secrets",
    ...
    print(f"{evidence.identifier}: Verify that the example uses a named placeholder secret mapping. -> {is_verified(evidence)}")
