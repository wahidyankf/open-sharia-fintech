"""Runnable verification for CI/CD Example 31: Wait for Deployment Approval."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-31-approval-wait",
    ...
    print(f"{evidence.identifier}: Verify that the workflow describes approval before the deploy command. -> {is_verified(evidence)}")
