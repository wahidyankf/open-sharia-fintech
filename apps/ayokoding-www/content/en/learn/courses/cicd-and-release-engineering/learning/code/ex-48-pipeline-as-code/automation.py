"""Runnable verification for CI/CD Example 48: Review Pipeline as Code."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-48-pipeline-as-code",
    ...
    print(f"{evidence.identifier}: Verify that the complete workflow is a tracked YAML file. -> {is_verified(evidence)}")
