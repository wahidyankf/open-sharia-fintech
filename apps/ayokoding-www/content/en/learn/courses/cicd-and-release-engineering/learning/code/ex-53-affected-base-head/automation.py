"""Runnable verification for CI/CD Example 53: Select Affected Base and Head."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-53-affected-base-head",
    ...
    print(f"{evidence.identifier}: Verify that the artifact records a base and a head revision. -> {is_verified(evidence)}")
