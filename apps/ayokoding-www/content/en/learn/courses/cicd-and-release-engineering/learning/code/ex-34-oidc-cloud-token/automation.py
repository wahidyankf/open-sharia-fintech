"""Runnable verification for CI/CD Example 34: Request a Short-Lived OIDC Token."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-34-oidc-cloud-token",
    ...
    print(f"{evidence.identifier}: Verify that id-token permission is present and the model uses a per-job token. -> {is_verified(evidence)}")
