"""Runnable verification for CI/CD Example 51: Avoid Public-Repository Runner Exposure."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-51-self-hosted-public-repo-risk",
    ...
    print(f"{evidence.identifier}: Verify that the modeled policy rejects fork pull requests on a sensitive runner. -> {is_verified(evidence)}")
