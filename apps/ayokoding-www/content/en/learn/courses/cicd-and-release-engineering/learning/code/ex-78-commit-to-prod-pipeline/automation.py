"""Runnable verification for CI/CD Example 78: Wire a Commit-to-Production Pipeline."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-78-commit-to-prod-pipeline",
    ...
    print(f"{evidence.identifier}: Verify that every stage has a visible dependency. -> {is_verified(evidence)}")
