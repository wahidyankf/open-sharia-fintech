"""Runnable verification for CI/CD Example 74: Measure Change Failure Rate."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-74-dora-change-failure-rate",
    ...
    print(f"{evidence.identifier}: Verify that the model divides failed deployments by total deployments. -> {is_verified(evidence)}")
