"""Runnable verification for CI/CD Example 38: Publish a Release Tag."""
...
def main() -> None:
    ...
    print(f"{evidence.identifier}: Verify that the artifact records a version-shaped tag before publishing. -> {is_verified(evidence)}")
