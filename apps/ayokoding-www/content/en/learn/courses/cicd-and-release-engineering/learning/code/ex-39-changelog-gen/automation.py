"""Runnable verification for CI/CD Example 39: Generate a Changelog."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-39-changelog-gen",
    ...
    print(f"{evidence.identifier}: Verify that feature and fix entries appear in separate groups. -> {is_verified(evidence)}")
