"""Runnable verification for CI/CD Example 12: Run a Minimal GitHub Actions Workflow."""
...
def main() -> None:
    ...
    print(f"{check.name}: Confirm the workflow contains a push trigger and one runnable job. -> {passes(check)}")
