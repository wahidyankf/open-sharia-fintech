"""Runnable verification for CI/CD Example 68: Record SLSA Provenance."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-68-slsa-provenance",
    ...
    print(f"{evidence.identifier}: Verify that the modeled attestation contains an artifact digest and source revision. -> {is_verified(evidence)}")
