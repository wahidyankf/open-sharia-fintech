"""Runnable verification for CI/CD Example 79: Evaluate Gate Cost."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-79-gates-cost-tradeoff",
    ...
    print(f"{evidence.identifier}: Verify that the decision records both the tax and the safety signal. -> {is_verified(evidence)}")
