"""Runnable verification for CI/CD Example 14: Choose Run or Uses."""
...
def main() -> None:
    ...
    print(f"{check.name}: Confirm the complete artifact contains both a command step and an action step. -> {passes(check)}")
