"""Runnable verification for CI/CD Example 26: Compare Pre-release Precedence."""
...
def main() -> None:
    ...
    print(f"{check.name}: Confirm the comparison reports the pre-release as lower precedence. -> {passes(check)}")
