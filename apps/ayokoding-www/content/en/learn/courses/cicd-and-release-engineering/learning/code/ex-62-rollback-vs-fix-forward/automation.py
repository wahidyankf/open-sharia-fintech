"""Runnable verification for CI/CD Example 62: Choose Rollback or Fix Forward."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-62-rollback-vs-fix-forward",
    ...
    print(f"{evidence.identifier}: Verify that the decision table records the recovery condition. -> {is_verified(evidence)}")
