"""Runnable verification for CI/CD Example 01: Daily Merge and Self-Testing Build."""
...
def main() -> None:
    ...
    print(f"{check.name}: Confirm the artifact records a shared mainline and a self-testing build before it reports success. -> {passes(check)}")
