"""Runnable verification for CI/CD Example 40: Automate the Release Decision."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-40-semantic-release",
    ...
    print(f"{evidence.identifier}: Verify that the artifact connects commit analysis to release output. -> {is_verified(evidence)}")
