"""Runnable verification for CI/CD Example 55: Order Gates for Fast Feedback."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-55-fail-fast-ordering",
    ...
    print(f"{evidence.identifier}: Verify that the ordering puts format and type checks before an end-to-end stage. -> {is_verified(evidence)}")
