"""Runnable verification for CI/CD Example 61: Practice Progressive Delivery."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-61-progressive-delivery",
    ...
    print(f"{evidence.identifier}: Verify that the model promotes only after every staged check passes. -> {is_verified(evidence)}")
