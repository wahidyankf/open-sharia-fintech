"""Runnable verification for CI/CD Example 47: Review Dependency Updates."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-47-dependency-scan",
    ...
    print(f"{evidence.identifier}: Verify that the artifact names all three update kinds. -> {is_verified(evidence)}")
