"""Runnable verification for CI/CD Example 46: Scan with CodeQL."""
...
def main() -> None:
    ...
    print(f"{evidence.identifier}: Verify that the workflow includes a CodeQL analysis job. -> {is_verified(evidence)}")
