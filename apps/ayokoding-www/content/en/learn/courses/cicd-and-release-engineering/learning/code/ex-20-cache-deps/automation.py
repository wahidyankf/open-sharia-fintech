"""Runnable verification for CI/CD Example 20: Cache Dependency Inputs."""
...
def main() -> None:
    ...
    print(f"{check.name}: Confirm the cache key hashes dependency inputs. -> {passes(check)}")
