"""Runnable verification for CI/CD Example 80: Preview the CI/CD Capstone."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-80-cicd-capstone",
    ...
    print(f"{evidence.identifier}: Verify that a simulated bad canary reports rollback while a verified artifact remains promotable. -> {is_verified(evidence)}")
