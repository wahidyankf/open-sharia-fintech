"""Runnable verification for CI/CD Example 58: Shift Canary Traffic Gradually."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-58-canary-gradual",
    ...
    print(f"{evidence.identifier}: Verify that the first traffic weight is smaller than the final weight. -> {is_verified(evidence)}")
