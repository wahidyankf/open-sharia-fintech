"""Runnable verification for CI/CD Example 59: Target a Canary Cohort."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-59-canary-cohort",
    ...
    print(f"{evidence.identifier}: Verify that a stable cohort key produces a consistent route. -> {is_verified(evidence)}")
