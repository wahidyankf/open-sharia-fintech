"""Runnable verification for CI/CD Example 11: Apply the GitFlow Continuous-Delivery Caveat."""
...
def main() -> None:
    ...
    print(f"{check.name}: Confirm the artifact records the caveat alongside the GitFlow model. -> {passes(check)}")
