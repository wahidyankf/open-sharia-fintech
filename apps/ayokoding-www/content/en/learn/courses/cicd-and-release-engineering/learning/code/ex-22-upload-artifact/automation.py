"""Runnable verification for CI/CD Example 22: Upload a Build Artifact."""
...
def main() -> None:
    ...
    print(f"{check.name}: Confirm the workflow uploads a named build artifact. -> {passes(check)}")
