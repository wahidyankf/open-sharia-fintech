"""Runnable verification for CI/CD Example 09: Use a Single Trunk."""
...
def main() -> None:
    ...
    print(f"{check.name}: Confirm the modeled branch policy permits short-lived changes but rejects long-lived branches. -> {passes(check)}")
