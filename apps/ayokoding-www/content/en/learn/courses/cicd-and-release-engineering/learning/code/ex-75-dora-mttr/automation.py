"""Runnable verification for CI/CD Example 75: Measure Failed-Deployment Recovery Time."""
...
def main() -> None:
    ...
    print(f"{evidence.identifier}: Verify that the model reports a recovery duration. -> {is_verified(evidence)}")
