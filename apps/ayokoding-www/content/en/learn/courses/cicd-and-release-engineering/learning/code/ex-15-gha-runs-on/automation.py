"""Runnable verification for CI/CD Example 15: Select a Hosted Runner."""
...
def main() -> None:
    ...
    print(f"{check.name}: Confirm the workflow selects ubuntu-latest for its verification job. -> {passes(check)}")
