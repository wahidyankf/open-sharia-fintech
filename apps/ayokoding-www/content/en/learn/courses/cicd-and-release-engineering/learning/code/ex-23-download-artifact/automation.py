"""Runnable verification for CI/CD Example 23: Download a Build Artifact."""
...
def main() -> None:
    ...
    print(f"{check.name}: Confirm the consuming job downloads the artifact after the producing job. -> {passes(check)}")
