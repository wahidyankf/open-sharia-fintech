"""Runnable verification for CI/CD Example 52: Run Affected Monorepo CI."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-52-monorepo-affected",
    ...
    print(f"{evidence.identifier}: Verify that the workflow runs nx affected for a named task. -> {is_verified(evidence)}")
