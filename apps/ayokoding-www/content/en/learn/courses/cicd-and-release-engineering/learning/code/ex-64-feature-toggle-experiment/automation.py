"""Runnable verification for CI/CD Example 64: Use an Experiment Toggle."""
...
def main() -> None:
    ...
    evidence = Evidence(
        ...
        identifier="ex-64-feature-toggle-experiment",
    ...
    print(f"{evidence.identifier}: Verify that the same user key selects the same cohort. -> {is_verified(evidence)}")
