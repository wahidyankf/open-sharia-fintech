...
{"id": "case-10", "fact_id": "offline-sync", "input": "Which plan supports offline sync, Free or Pro?", "expected": "pro only", "scorer": "normalized_match", "criterion": "normalized answer must equal 'pro only'"}
