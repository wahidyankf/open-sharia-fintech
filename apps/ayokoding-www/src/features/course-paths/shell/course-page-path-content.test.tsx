...
vi.mock("./use-runtime-course-path-data", () => ({
  useRuntimeCoursePathData: useRuntimeCoursePathDataMock,
}));

vi.mock("./course-page-content", () => ({
  CoursePageContent: ({
    renderData,
  }: {
    renderData: { prerequisiteLinks: readonly { title: string }[]; pathBadges: readonly { title: string }[] };
  }) => (
    <div>
...
import { CoursePagePathContent } from "./course-page-path-content";
