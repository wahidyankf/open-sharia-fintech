/**
 * Step definitions for the roots-be health endpoint feature.
 *
 * Covers: specs/apps/roots/be/behaviours/health/health.feature
 */
...
Given("the roots-be service is running", async ({ request }) => {
