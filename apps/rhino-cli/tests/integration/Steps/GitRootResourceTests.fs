/// Integration tests for `RhinoCli.Infrastructure.GitRoot.findRoot`.
...
/// -wide opt-out declared here, which also protects `ParityResourceTests`'s own
/// git-fixture tests elsewhere in this run.
module RhinoCli.Tests.Integration.Steps.GitRootResourceTests
...
/// `ParityResourceTests.newGitFixture`, duplicated here rather than shared
