 ...
 *
 * Covers: specs/apps/organiclever/behavior/organiclever-app-web/gherkin/env-loader/env-loader.feature
 *
...
import { loadTierEnv, resolveTier } from "../../../src/contexts/env-loader/infrastructure/env-loader";

const feature = await loadFeature(
  path.resolve(
    __dirname,
    "../../../../../specs/apps/organiclever/behavior/organiclever-app-web/gherkin/env-loader/env-loader.feature",
  ),
);
...
describeFeature(feature, ({ Scenario, ScenarioOutline, AfterEachScenario }) => {
  ...
  Scenario("organiclever-app-web builds against the staging tier", ({ Given, When, Then }) => {
    ...
    // @covers specs/apps/organiclever/behavior/organiclever-app-web/gherkin/env-loader/env-loader.feature:organiclever-app-web builds against the staging tier
  ...
  Scenario("organiclever-app-web process env wins over the local tier file", ({ Given, When, Then, And }) => {
    ...
    // @covers specs/apps/organiclever/behavior/organiclever-app-web/gherkin/env-loader/env-loader.feature:organiclever-app-web process env wins over the local tier file
  ...
  Scenario("organiclever-app-web tolerates a missing tier file", ({ Given, When, Then, And }) => {
    ...
    // @covers specs/apps/organiclever/behavior/organiclever-app-web/gherkin/env-loader/env-loader.feature:organiclever-app-web tolerates a missing tier file
  ...
  ScenarioOutline(
    ...
    ({ Given, When, Then }, examples) => {
      ...
      // @covers specs/apps/organiclever/behavior/organiclever-app-web/gherkin/env-loader/env-loader.feature:organiclever-app-web fails loudly on a stray auto-loaded env file
