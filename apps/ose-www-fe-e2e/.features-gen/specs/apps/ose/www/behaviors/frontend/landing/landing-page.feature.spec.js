...
test.describe('Landing Page', () => {
  ...
  test('Hero section displays platform information', { tag: ['@unit', '@e2e'] }, async ({ When, Then, And, page }) => { 
    await When('the landing page is rendered', null, { page }); 
  ...
  test('Social icons are displayed', { tag: ['@unit', '@e2e'] }, async ({ When, Then, And, page }) => { 
    await When('the landing page is rendered', null, { page }); 
